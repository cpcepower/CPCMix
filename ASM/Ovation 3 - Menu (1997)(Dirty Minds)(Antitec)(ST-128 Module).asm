; Music of Ovation 3 - Menu (1997)(Dirty Minds)(Antitec)(ST-128 Module)
...
.l86c0
	...
	db #00,#0c,#18,#00,#0c,#18,#00,#0c
	db #00,#90,#89,#00,#90,#89,#00,#d9
	db #89,#00,#22,#8a,#00,#90,#89,#00
	db #90,#89,#00,#b4,#8a,#00,#b4,#8a
	db #00,#90,#89,#00,#90,#89,#00,#d9
	db #89,#00,#22,#8a,#00,#6b,#8a,#00
	db #46,#8b,#00,#fd,#8a,#80,#00,#89
	db #00,#8f,#8b,#00,#8f,#8b,#00,#c9
	db #8b,#00,#f7,#8b,#00,#8f,#8b,#00
	db #8f,#8b,#00,#43,#8c,#00,#43,#8c
	db #00,#8f,#8b,#00,#8f,#8b,#00,#c9
	db #8b,#00,#f7,#8b,#00,#0c,#8c,#00
	db #a1,#8c,#00,#8c,#8c,#80,#30,#89
	db #00,#fd,#8c,#00,#fd,#8c,#00,#4a
	db #8d,#00,#93,#8d,#00,#fd,#8c,#00
	db #fd,#8c,#00,#28,#8e,#00,#28,#8e
	db #00,#fd,#8c,#00,#fd,#8c,#00,#4a
	db #8d,#00,#93,#8d,#00,#df,#8d,#00
	db #c6,#8e,#00,#75,#8e,#80,#60,#89
	db #31,#70,#02,#3d,#70,#02,#31,#70
	db #02,#3d,#70,#02,#31,#70,#02,#3d
	db #70,#02,#31,#70,#02,#3d,#70,#02
	db #31,#70,#02,#3d,#70,#02,#31,#70
	db #02,#3d,#70,#02,#31,#70,#02,#3d
	db #70,#02,#31,#70,#02,#bd,#40,#49
	db #70,#02,#4c,#70,#02,#4e,#70,#03
	db #ce,#70,#4c,#70,#02,#c9,#70,#2a
	db #70,#02,#36,#70,#02,#2a,#70,#02
	db #ff,#2f,#70,#02,#3b,#70,#02,#2f
	db #70,#02,#3b,#70,#02,#2f,#70,#02
	db #3b,#70,#02,#2f,#70,#02,#3b,#70
	db #02,#2f,#70,#02,#3b,#70,#02,#2f
	db #70,#02,#3b,#70,#02,#31,#70,#02
	db #3d,#70,#02,#31,#70,#02,#3d,#70
	db #02,#31,#70,#02,#3d,#70,#02,#31
	db #70,#02,#3d,#70,#02,#2f,#70,#02
	db #3b,#70,#02,#2f,#70,#02,#3b,#70
	db #02,#ff,#2f,#70,#02,#3b,#70,#02
	db #2f,#70,#02,#3b,#70,#02,#31,#70
	db #02,#3d,#70,#02,#31,#70,#02,#3d
	db #70,#02,#31,#70,#02,#3d,#70,#02
	db #31,#70,#02,#3d,#70,#02,#31,#70
	db #02,#3d,#70,#02,#31,#70,#02,#3d
...
;
.music_info
	db "Ovation 3 - Menu (1997)(Dirty Minds)(Antitec)",0
	db "ST-128 Module",0
