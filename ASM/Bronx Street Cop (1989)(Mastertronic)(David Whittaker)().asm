; Music of Bronx Street Cop (1989)(Mastertronic)(David Whittaker)()
...
.l971f
	...
	db #2e,#8e
.l9731
	db #8a,#88,#01,#01,#d1,#e2,#25,#e0
	db #25,#25,#e1,#25,#25,#25,#eb,#d2
.l9742 equ $ + 1
	db #25,#8a,#88,#01,#01,#d1,#e2,#29
	db #e0,#1d,#1d,#e1,#2a,#2a,#2a,#eb
	db #d2,#2a
.l9757 equ $ + 4
.l9755 equ $ + 2
.l9753
	dw l9759,l976f,l9783
.l9759
	db #8a,#88,#01,#01,#d1,#e1,#13,#1f
	db #13,#1f,#13,#1f,#13,#1f,#18,#24
.l976f equ $ + 6
	db #18,#24,#ef,#d2,#18,#8e,#8a,#88
	db #01,#01,#d1,#e1,#26,#e7,#23,#e1
	db #26,#e2,#2b,#e0,#26,#e1,#2b,#f7
.l9783 equ $ + 2
	db #d2,#28,#8a,#88,#01,#01,#d1,#e1
	db #2b,#e7,#26,#e1,#2b,#e2,#2f,#e0
	db #2b,#e1,#30,#f7,#d2,#2b
.l9797
	dw l97a3,#0000
.l979b
	dw l97cb,#0000
...
.l97a3
	db #88,#01,#01,#90
.l97a7
	db #8a,#d1,#e0,#13,#1a,#1f,#13,#1a
	db #1f,#13,#1a,#1f,#13,#1a,#1f,#13
	db #1a,#1f,#13,#11,#1a,#1d,#11,#1a
	db #1d,#11,#1a,#1d,#11,#1a,#1d,#11
.l97cb equ $ + 4
	db #1a,#1d,#11,#87,#88,#01,#01,#8a
	db #d1,#e0,#1a,#1f,#23,#1a,#1f,#23
	db #1a,#1f,#e1,#26,#e0,#23,#e4,#23
	db #e0,#1a,#1d,#21,#1a,#1d,#21,#1a
	db #1d,#e1,#26,#e0,#21,#e4,#21,#e0
	db #26,#2b,#2f,#26,#2b,#2f,#26,#2b
	db #88,#01,#02,#e7,#32,#ef,#8f,#87
;
.music_info
	db "Bronx Street Cop (1989)(Mastertronic)(David Whittaker)",0
	db "",0
