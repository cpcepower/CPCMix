; Music of Ze Meeting 95 - No Rest Part (1995)(Condense)()(ST-Module)
...
.l67da equ $ + 4
	...
	db #1c,#04,#10,#0f,#0f,#0f,#0f,#0e
	db #0e,#0d,#0c,#0c,#0b,#0a,#09,#08
	db #07,#05,#04,#03,#02,#00,#00,#01
	db #02,#04,#05,#06,#07,#08,#09,#0a
	db #0b,#0c,#0d,#0d,#0e,#0e,#0f,#0f
	db #0f,#0f,#0f,#0f,#0f,#0f,#0e,#0e
	db #0d,#0d,#0c,#0b,#0a,#09,#08,#07
	db #06,#05,#04,#02,#01,#00,#00,#02
	db #03,#04,#05,#07,#08,#09,#0a,#0b
	db #0c,#0c,#0d,#0e,#0e,#0f,#0f,#0f
	db #0f,#10,#ff
;
.music_info
	db "Ze Meeting 95 - No Rest Part (1995)(Condense)()",0
	db "ST-Module",0
