; Music of Dracula Fanz Issue 5 - Cours ASM (1995)(Dracula Fanz Team)(Beta Soft Cologne)(ST-128 Module)
...
.l626e equ $ + 4
.l626a
	db #08,#00,#01,#08,#a4,#02,#00,#1e
.l6278 equ $ + 6
	db #00,#00,#00,#00,#da,#00,#da,#64
	db #1a,#65,#fa,#63,#00,#00,#0f,#11
.l6289 equ $ + 7
	db #00,#00,#00,#00,#00,#00,#00,#01
	db #1e,#68,#7b,#66,#01,#60,#00,#00
.l6298 equ $ + 6
	db #00,#00,#00,#00,#01,#01,#09,#02
.l629c equ $ + 2
	db #03,#10,#b3,#00,#00,#31,#00,#00
.l62a6 equ $ + 4
	db #00,#00,#da,#65,#9a,#63,#ba,#64
	db #fa,#63,#00,#00,#20,#00,#00,#00
.l62b7 equ $ + 5
	db #00,#00,#00,#00,#00,#17,#d5,#68
	db #b7,#66,#01,#ff,#00,#00,#00,#00
.l62c6 equ $ + 4
	db #00,#00,#01,#01,#0a,#04,#05,#20
.l62ca
	db #96,#00,#00,#38,#00,#00,#00,#00
.l62d4 equ $ + 2
	db #1a,#66,#9a,#63,#ba,#65,#fa,#63
	db #00,#00,#0f,#11,#00,#00,#00,#02
.l62e5 equ $ + 3
	db #02,#00,#00,#01,#18,#6b,#f3,#66
	db #01,#80,#00,#00,#00,#00,#00,#00
.l62f4 equ $ + 2
	db #01,#01,#5a,#66,#96,#66,#d2,#66
.l62fa
...
.l637a
	...
	db #80,#02,#40,#80,#02,#ff,#fe,#00

;
.music_info
	db "Dracula Fanz Issue 5 - Cours ASM (1995)(Dracula Fanz Team)(Beta Soft Cologne)",0
	db "ST-128 Module",0
