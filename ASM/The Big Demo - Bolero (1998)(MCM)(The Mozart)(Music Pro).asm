; Music of The Big Demo - Bolero (1998)(MCM)(The Mozart)(Music Pro)
...
.l8004 equ $ + 2
.l8002
	db #ac,#00,#ac,#01,#50,#00,#6c,#00
.l800c equ $ + 2
.l800a
	db #8c,#00,#ac,#02,#b4,#02,#b4,#02
	db #cb,#02,#e2,#02,#f9,#02,#13,#03
	db #2d,#03,#4e,#03,#71,#03,#71,#03
	db #71,#03,#88,#03,#a0,#03,#e7,#03
	db #0e,#04,#28,#04,#46,#04,#50,#04
	db #67,#04,#7e,#04,#95,#04,#bc,#04
	db #e3,#04,#fa,#04,#11,#05,#48,#05
	db #7f,#05,#b6,#05,#ed,#05,#54,#06
	db #bb,#06,#bb,#06,#f2,#06,#00,#06
	db #02,#02,#03,#04,#05,#07,#08,#08
	db #0b,#0c,#0b,#0c,#05,#05,#02,#02
	db #04,#03,#0e,#0e,#0d,#0d,#0f,#10
	db #11,#ff,#12,#12,#12,#13,#14,#14
	db #12,#12,#14,#14,#15,#16,#15,#16
	db #12,#12,#12,#13,#14,#14,#15,#16
	db #15,#16,#15,#16,#15,#16,#17,#18
	db #12,#ff,#19,#19,#19,#1a,#1b,#1c
	db #19,#1a,#1b,#1c,#1d,#1e,#1d,#1e
	db #19,#19,#19,#1a,#1c,#1b,#1d,#1e
	db #1d,#1e,#1d,#1e,#1d,#1e,#20,#21
	db #19,#ff,#0f,#00,#0f,#00,#0f,#00
	db #0f,#00,#01,#0d,#0d,#ff,#01,#00
	db #01,#00,#01,#0b,#0b,#ff,#01,#00
	db #01,#00,#01,#09,#09,#ff,#01,#00
	db #01,#00,#01,#07,#07,#ff,#01,#00
	db #01,#00,#01,#0a,#03,#00,#03,#00
	db #01,#00,#01,#0a,#01,#00,#8c,#f8
	db #01,#00,#01,#07,#01,#00,#01,#00
	db #01,#00,#01,#0a,#01,#00,#01,#00
	db #01,#00,#01,#0f,#0f,#ff,#02,#00
	db #0b,#00,#01,#0d,#0d,#ff,#08,#00
	db #0a,#00,#01,#0f,#01,#00,#03,#fb
	...
	db #01,#01,#08,#00,#01,#01,#01,#01
	db #01,#01,#01,#00,#01,#00,#01,#01
	db #01,#ff,#c0,#e1,#01,#8b,#e0,#00
	db #00,#ff,#c5,#e1,#02,#85,#e0,#00
	db #44,#87,#4c,#83,#4b,#4e,#85,#45
	db #83,#40,#44,#85,#3f,#83,#40,#42
	db #ff,#c5,#e1,#02,#85,#e0,#00,#47
	db #87,#50,#83,#4e,#51,#85,#49,#83
	db #4b,#4e,#85,#4b,#83,#4c,#4e,#ff
	db #c5,#e1,#02,#85,#e0,#00,#47,#87
	db #50,#83,#4e,#51,#85,#49,#83,#4b
	db #4e,#85,#47,#83,#45,#4b,#ff,#c6
	db #e1,#02,#89,#e0,#00,#44,#c7,#81
	db #42,#45,#40,#3d,#3c,#44,#3b,#38
	db #39,#42,#39,#36,#38,#42,#40,#3c
	db #ff,#c0,#e1,#02,#89,#e0,#00,#00
	db #c7,#81,#42,#45,#40,#3d,#3f,#44
	db #3b,#38,#39,#42,#40,#3d,#3f,#42
	db #40,#3c,#ff,#c7,#e1,#02,#85,#e0
	db #00,#38,#c8,#44,#c6,#e1,#01,#87
	db #44,#c7,#81,#42,#45,#40,#3d,#3c
	db #44,#3b,#38,#39,#42,#39,#36,#38
	db #42,#40,#3c,#ff,#c8,#e1,#02,#85
	db #e0,#00,#3b,#47,#c6,#e1,#01,#47
	db #c7,#81,#49,#4c,#4b,#47,#45,#49
	db #47,#44,#42,#45,#44,#40,#3f,#42
	db #40,#3d,#3f,#40,#3d,#3f,#ff,#c7
	db #e1,#01,#85,#e0,#00,#47,#3f,#40
	db #47,#49,#3f,#40,#49,#4b,#3f,#40
	db #4b,#4c,#3f,#40,#49,#ff,#c7,#e1
	db #01,#85,#e0,#00,#47,#3f,#40,#87
	db #47,#85,#45,#49,#3f,#47,#3f,#40
	db #44,#47,#40,#42,#3b,#ff,#c5,#e1
	db #01,#83,#e0,#00,#47,#3b,#3d,#3f
	db #40,#44,#47,#40,#49,#3d,#3f,#40
	db #45,#47,#49,#40,#4b,#3f,#40,#42
	db #44,#47,#4b,#40,#4c,#3f,#40,#45
	db #49,#4b,#4c,#49,#4b,#3f,#40,#42
	db #44,#47,#4b,#40,#49,#3d,#3f,#40
	db #45,#49,#4b,#40,#47,#3b,#3d,#3f
	db #40,#44,#47,#40,#45,#3d,#3f,#40
	db #42,#44,#45,#3f,#ff,#c5,#e1,#01
	db #85,#e0,#00,#47,#3f,#40,#47,#49
	db #3f,#40,#49,#4b,#3f,#40,#4b,#4c
	db #3f,#40,#49,#47,#3f,#40,#47,#45
	db #42,#44,#45,#47,#3f,#40,#44,#45
	db #47,#49,#4b,#ff,#c6,#e1,#01,#89
	db #e0,#00,#47,#c7,#81,#45,#4c,#4b
	db #44,#42,#49,#47,#40,#3f,#45,#44
	db #3d,#3b,#45,#44,#3f,#ff,#c5,#e1
	db #01,#85,#e0,#00,#40,#47,#c6,#87
	db #47,#c7,#81,#45,#4c,#4b,#44,#42
	db #49,#47,#40,#3f,#45,#44,#3d,#3b
	db #42,#3f,#3c,#ff,#c6,#e1,#01,#89
	db #e0,#00,#31,#c0,#00,#ff,#c5,#e1
	db #01,#83,#e0,#00,#19,#20,#24,#25
	db #24,#25,#27,#28,#27,#25,#20,#19
	db #18,#21,#18,#20,#ff,#c5,#e1,#02
	db #83,#e0,#00,#19,#20,#24,#25,#24
	db #25,#27,#28,#27,#25,#20,#1c,#17
	db #1b,#21,#23,#ff,#c5,#e1,#02,#83
	db #e0,#00,#17,#1c,#20,#28,#27,#28
	db #2a,#2c,#2a,#28,#27,#25,#27,#2a
	db #25,#27,#ff,#c8,#e1,#01,#83,#e0
	db #00,#23,#27,#28,#2c,#23,#27,#28
	db #2c,#25,#27,#28,#2d,#25,#27,#28
	db #2d,#27,#28,#2c,#2f,#27,#28,#2c
	db #2f,#27,#28,#2d,#31,#27,#28,#2d
	db #31,#ff,#c5,#e1,#01,#83,#e0,#00
	db #27,#28,#2c,#2f,#27,#28,#2c,#2f
	db #25,#27,#28,#2d,#25,#27,#28,#2a
	db #23,#27,#28,#2c,#23,#27,#28,#2c
	db #21,#25,#27,#28,#23,#27,#28,#2a
	db #ff,#c8,#e1,#01,#83,#e0,#00,#27
	db #28,#2c,#2f,#33,#34,#31,#2f,#2d
	db #2c,#2a,#28,#27,#25,#23,#21,#ff
	db #c5,#e1,#01,#83,#e0,#00,#27,#28
	db #2c,#2f,#33,#34,#31,#2f,#2d,#31
	db #2a,#28,#27,#2a,#25,#24,#ff,#a0
	db #c1,#e1,#01,#82,#e0,#00,#25,#c2
	db #25,#c3,#25,#c4,#25,#c3,#25,#c2
	db #25,#c1,#25,#c2,#25,#c3,#25,#c4
	db #25,#c3,#25,#c2,#25,#c1,#25,#c2
	db #25,#c3,#25,#c4,#25,#c3,#25,#c2
	db #25,#c1,#24,#c2,#24,#c3,#24,#c4
	db #24,#c3,#24,#c2,#24,#ff,#a0,#c1
	db #e1,#02,#82,#e0,#00,#25,#c2,#25
	db #c3,#25,#c4,#25,#c3,#25,#c2,#25
	db #c1,#25,#c2,#25,#c3,#25,#c4,#25
	db #c3,#25,#c2,#25,#c1,#25,#c2,#25
	db #c3,#25,#c4,#25,#c3,#25,#c2,#25
	db #c1,#23,#c2,#23,#c3,#23,#c4,#23
	db #c3,#23,#c2,#23,#ff,#a0,#c1,#e1
	db #02,#82,#e0,#00,#1c,#c2,#1c,#c3
	db #1c,#c4,#1c,#c3,#1c,#c2,#1c,#c1
	db #1c,#c2,#1c,#c3,#1c,#c4,#1c,#c3
	db #1c,#c2,#1c,#c1,#21,#c2,#21,#c3
	db #21,#c4,#21,#c3,#21,#c2,#21,#c1
	db #23,#c2,#23,#c3,#23,#c4,#21,#c3
	db #21,#c2,#21,#ff,#a0,#c1,#e1,#02
	db #82,#e0,#00,#1c,#c2,#1c,#c3,#1c
	db #c4,#1c,#c3,#1c,#c2,#1c,#c1,#1c
	db #c2,#1c,#c3,#1c,#c4,#1c,#c3,#1c
	db #c2,#1c,#c1,#21,#c2,#21,#c3,#21
	db #c4,#21,#c3,#21,#c2,#21,#c1,#23
	db #c2,#23,#c3,#23,#c4,#1b,#c3,#1b
	db #c2,#1b,#ff,#a0,#c1,#e1,#01,#82
	db #e0,#00,#1c,#c2,#1c,#c3,#1c,#c4
	db #1c,#c3,#1c,#c2,#1c,#c1,#1c,#c2
	db #1c,#c3,#1c,#c4,#1c,#c3,#1c,#c2
	db #1c,#c1,#1e,#c2,#1e,#c3,#1e,#c4
	db #1e,#c3,#1e,#c2,#1e,#c1,#1e,#c2
	db #1e,#c3,#1e,#c4,#1e,#c3,#1e,#c2
	db #1e,#c1,#20,#c2,#20,#c3,#20,#c4
	db #20,#c3,#20,#c2,#20,#c1,#20,#c2
	db #20,#c3,#20,#c4,#20,#c3,#20,#c2
	db #20,#c1,#21,#c2,#21,#c3,#21,#c4
	db #21,#c3,#21,#c2,#21,#c1,#21,#c2
	db #21,#c3,#21,#c4,#21,#c3,#21,#c2
	db #21,#ff,#a0,#c1,#e1,#01,#82,#e0
	db #00,#2c,#c2,#2c,#c3,#2c,#c4,#2c
	db #c3,#2c,#c2,#2c,#c1,#2c,#c2,#2c
	db #c3,#2c,#c4,#2c,#c3,#2c,#c2,#2c
	db #c1,#2a,#c2,#2a,#c3,#2a,#c4,#2a
	db #c3,#2a,#c2,#2a,#c1,#2a,#c2,#2a
	db #c3,#2a,#c4,#2a,#c3,#2a,#c2,#2a
	db #c1,#2c,#c2,#2c,#c3,#2c,#c4,#2c
	db #c3,#2c,#c2,#2c,#c1,#2c,#c2,#2c
	db #c3,#2c,#c4,#2c,#c3,#2c,#c2,#2c
	db #c1,#2d,#c2,#2d,#c3,#2d,#c4,#2d
	db #c3,#2d,#c2,#2d,#c1,#2f,#c2,#2f
	db #c3,#2f,#c4,#2f,#c3,#2f,#c2,#2f
	db #ff,#a0,#c1,#e1,#01,#82,#e0,#00
	db #1c,#c2,#1c,#c3,#1c,#c4,#1c,#c3
	db #1c,#c2,#1c,#c1,#1c,#c2,#1c,#c3
	db #1c,#c4,#1c,#c3,#1c,#c2,#1c,#c1
	db #1e,#c2,#1e,#c3,#1e,#c4,#1e,#c3
	db #1e,#c2,#1e,#c1,#23,#c2,#23,#c3
	db #23,#c4,#23,#c3,#23,#c2,#23,#ff
	db #a0,#c1,#e1,#01,#82,#e0,#00,#1c
	db #c2,#1c,#c3,#1c,#c4,#1c,#c3,#1c
	db #c2,#1c,#c1,#1c,#c2,#1c,#c3,#1c
	db #c4,#1c,#c3,#1c,#c2,#1c,#c1,#21
	db #c2,#21,#c3,#21,#c4,#21,#c3,#21
	db #c2,#21,#c1,#23,#c2,#23,#c3,#23
	db #c4,#24,#c3,#24,#c2,#24,#ff,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
...
;
.music_info
	db "The Big Demo - Bolero (1998)(MCM)(The Mozart)",0
	db "Music Pro",0
