; Music of Ghoul's Writer Muzaxx Collector Last Part (19xx)(Scorpion)()(ST Module)
...
.l63da equ $ + 4
	db #00,#00,#00,#00,#e4,#8f,#00,#01
	db #08,#00,#01,#3e,#00,#00,#00,#df
.l63e8 equ $ + 2
	db #12,#8e,#06,#8a,#46,#8a,#66,#8a
	db #07,#00,#07,#19,#6a,#00,#c6,#8d
.l63f6
	db #f0,#90,#02,#03,#09,#04,#03,#26
.l6404 equ $ + 6
	db #00,#00,#00,#e7,#6c,#8e,#a6,#8b
	db #e6,#8b,#66,#8a,#08,#18,#07,#19
.l6412 equ $ + 4
	db #aa,#01,#00,#00,#4a,#93,#04,#05
	db #0a,#03,#01,#29,#00,#00,#00,#ef
.l6420 equ $ + 2
	db #c6,#8e,#26,#8b,#66,#8b,#86,#8b
	db #07,#00,#07,#19,#66,#01,#00,#00
...
.l6442 equ $ + 4
	...
	db #e2,#65,#1a,#00,#02,#66,#42,#66
	db #62,#66,#07,#00,#82,#66,#c2,#66
	db #42,#65,#08,#18,#00,#84,#00,#84
	db #00,#84,#00,#00,#e2,#66,#22,#67
	db #42,#65,#00,#00,#e2,#64,#42,#67
	db #62,#67,#06,#00,#82,#67,#c2,#67
	db #42,#65,#00,#00,#e2,#64,#e2,#67
	db #42,#65,#1b,#00,#e2,#64,#22,#65
	db #02,#68,#00,#00,#e2,#64,#22,#68
	db #42,#68,#00,#00,#00,#84,#00,#84
	db #00,#84,#00,#00,#00,#84,#00,#84
	db #00,#84,#00,#00,#00,#84,#00,#84
	db #00,#84,#00,#00,#00,#84,#00,#84
.l64c2 equ $ + 4
	db #00,#84,#00,#00,#62,#68,#82,#68
	db #00,#84,#00,#84,#00,#84,#00,#84
	db #00,#84,#00,#84,#a2,#68,#00,#84
	db #c2,#68,#00,#84,#00,#84,#00,#84
...
;
.music_info
	db "Ghoul's Writer Muzaxx Collector Last Part (19xx)(Scorpion)()",0
	db "ST Module",0
