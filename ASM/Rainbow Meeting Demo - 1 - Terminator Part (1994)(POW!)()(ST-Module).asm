; Music of Rainbow Meeting Demo - 1 - Terminator Part (1994)(POW!)()(ST-Module)
...
.l9466 equ $ + 4
	...
	db #66,#95,#1a,#00,#00,#8f,#00,#8f
	db #00,#8f,#00,#00,#86,#95,#c6,#95
	db #e6,#95,#08,#18,#00,#8f,#00,#8f
	db #00,#8f,#00,#00,#00,#8f,#00,#8f
	db #00,#8f,#00,#00,#00,#8f,#00,#8f
	db #00,#8f,#00,#00,#00,#8f,#00,#8f
	db #00,#8f,#00,#00,#00,#8f,#00,#8f
...
;
.music_info
	db "Rainbow Meeting Demo - 1 - Terminator Part (1994)(POW!)()",0
	db "ST-Module",0
