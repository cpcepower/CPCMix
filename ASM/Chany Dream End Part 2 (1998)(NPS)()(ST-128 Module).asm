; Music of Chany Dream End Part 2 (1998)(NPS)()(ST-128 Module)
...
.l45b4 equ $ + 4
.l45b0
	db #08,#00,#01,#08,#5f,#00,#00,#40
	db #00,#00,#00,#00,#80,#49
.l45be
	db #60,#48,#a0,#48,#40,#47,#40,#00
	db #20,#00,#00,#0c,#00,#00,#00,#00
	db #00
.l45cf
	db #01,#05,#4c,#e7,#49,#00,#40,#00
.l45de equ $ + 7
	db #00,#00,#00,#00,#00,#01,#01,#09
.l45e2 equ $ + 3
	db #02,#03,#10,#f6,#02,#10,#1c,#00
	db #00,#00,#00,#00,#00
.l45ec
	db #e0,#46,#20,#47,#40,#47,#1a,#06
	db #06,#1a,#00,#00,#00,#00,#00,#00
	db #00
.l45fd
	db #01,#a9,#4d,#1d,#4a,#00,#00,#00
.l460c equ $ + 7
	db #00,#00,#00,#00,#00,#01,#01,#0a
.l4610 equ $ + 3
	db #04,#05,#20,#00,#00,#00,#64,#00
	db #00,#00,#00,#40,#00
.l461a
...
.l4640
	...
	db #e0,#47,#20,#48,#40,#48,#9a,#06
	db #de,#0b,#a8,#0b,#a8,#07,#de,#07
	db #60,#48,#a0,#48,#40,#47,#40,#00
	db #c0,#48,#00,#49,#20,#49,#c0,#00
	db #d2,#07,#a4,#0b,#a4,#0b,#d6,#0b
	db #de,#ff,#a8,#07,#ac,#ff,#da,#ff
	db #da,#0b,#b0,#0b,#a4,#07,#de,#07
	db #de,#07,#a4,#ff,#a4,#03,#de,#0b
	db #de,#0b,#12,#49,#32,#49,#de,#0b
	db #52,#49,#72,#49,#b0,#0b,#de,#0b
	db #b0,#0b,#b0,#0b,#b0,#0b,#da,#0b
	db #b0,#0b,#a4,#ff,#a8,#0b,#de,#0b
	db #b0,#0b,#d2,#ff,#d2,#ff,#00,#00
	db #d2,#ff,#d2,#ff,#d2,#ff,#00,#00
.l46c0
	db #40,#49,#60,#49,#d2,#ff,#80,#49
	...
	db #00,#01,#00,#ff,#ff,#ff,#ff,#00
	db #00,#00,#00,#01,#00,#01,#00,#0f
	db #0e,#0c,#0c,#0c,#0c,#0c,#0c,#0c
	...
	db #10,#42,#0f,#11,#74,#21,#10,#42
	db #0f,#11,#74,#21,#10,#42,#0f,#11
	db #74,#21,#10,#ff,#00,#00,#00,#00
	db #40,#3f,#3f,#3f,#3f,#3f,#3f,#3f
	db #3f,#3f,#3f,#3e,#3e,#3e,#3e,#3d
	db #3d,#3d,#3c,#3c,#3c,#3b,#3b,#3b
	db #3a,#3a,#39,#39,#38,#38,#37,#37
	db #36,#36,#35,#34,#34,#33,#33,#32
	db #31,#31,#30,#2f,#2f,#2e,#2d,#2c
	db #2c,#2b,#2a,#2a,#29,#28,#27,#27
	db #26,#25,#24,#23,#23,#22,#21,#20
	db #20,#1f,#1e,#1d,#1c,#1c,#1b,#1a
	db #19,#18,#18,#17,#16,#15,#15,#14
	db #13,#13,#12,#11,#10,#10,#0f,#0e
	...
	db #31,#32,#33,#33,#34,#34,#35,#36
	db #36,#37,#37,#38,#38,#39,#39,#3a
	db #3a,#3b,#3b,#3b,#3c,#3c,#3c,#3d
	db #3d,#3d,#3e,#3e,#3e,#3e,#3f,#3f
	db #3f,#3f,#3f,#3f,#3f,#3f,#3f,#3f
	db #eb,#c3,#ff,#ff
;
.music_info
	db "Chany Dream End Part 2 (1998)(NPS)()",0
	db "ST-128 Module",0
