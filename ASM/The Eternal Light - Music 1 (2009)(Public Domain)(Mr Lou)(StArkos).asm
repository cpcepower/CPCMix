; Music of The Eternal Light - Music 1 (2009)(Public Domain)(Mr Lou)(StArkos)
...
;
	ds #5000-$,#00
;
.l5000	; music rabbit.bin StArkos 
;
...
;
.music_info
	db "The Eternal Light - Music 1 (2009)(Public Domain)(Mr Lou)",0
	db "StArkos",0
