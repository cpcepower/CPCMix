; Music of Ghoul's Writer Muzaxx Collector Alien (19xx)(Scorpion)()(ST Module)
...
.l630c
	...
	db #00,#00,#00,#00
.l63da
	db #e6,#4d,#00,#01,#08,#05,#02,#28
.l63e8 equ $ + 6
	db #00,#00,#00,#df,#57,#4a,#e2,#44
	db #42,#47,#42,#45,#1c,#04,#05,#1b
.l63f6 equ $ + 4
	db #7b,#01,#00,#00,#e7,#50,#02,#03
	db #09,#0c,#02,#15,#00,#00,#00,#e7
.l6404 equ $ + 2
	db #7a,#4b,#e2,#44,#42,#49,#42,#45
	db #00,#00,#05,#1b,#70,#04,#00,#00
.l6412
	db #32,#53,#04,#05,#0a,#07,#06,#30
.l6420 equ $ + 6
	db #00,#00,#00,#ef,#9d,#4c,#e2,#47
	db #22,#48,#42,#48,#00,#00,#05,#1b
	db #ef,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#53,#54
	db #2d,#4d,#6f,#64,#75,#6c,#65,#2e
.l6442
	db #e2,#64,#22,#65,#42,#65,#00,#00
	db #62,#65,#a2,#65,#42,#65,#18,#08
	db #c2,#65,#02,#66,#22,#66,#00,#00
	db #42,#66,#82,#66,#a2,#66,#00,#00
	db #c2,#66,#02,#67,#22,#67,#00,#00
	db #e2,#64,#42,#67,#42,#65,#1c,#04
	db #62,#67,#a2,#67,#c2,#67,#00,#00
	db #e2,#67,#22,#68,#42,#68,#00,#00
	db #e2,#64,#62,#68,#42,#65,#00,#00
	db #82,#68,#c2,#68,#42,#65,#18,#08
	db #e2,#64,#62,#68,#42,#65,#00,#00
	db #e2,#68,#22,#69,#22,#67,#00,#00
	db #e2,#64,#42,#69,#42,#65,#00,#00
	db #dc,#3e,#dc,#3e,#dc,#3e,#00,#00
	db #dc,#3e,#dc,#3e,#dc,#3e,#00,#00
	db #62,#69,#a2,#69,#22,#67,#00,#00
.l64c2
	db #dc,#3e,#dc,#3e,#dc,#3e,#dc,#3e
	db #c2,#69,#e2,#69,#dc,#3e,#02,#6a
	db #22,#6a,#dc,#3e,#dc,#3e,#dc,#3e
	db #dc,#3e,#dc,#3e,#dc,#3e,#dc,#3e
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
...
;
.music_info
	db "Ghoul's Writer Muzaxx Collector Alien (19xx)(Scorpion)()",0
	db "ST Module",0
