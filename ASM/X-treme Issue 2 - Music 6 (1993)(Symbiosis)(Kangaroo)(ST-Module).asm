; Music of X-treme Issue 2 - Music 6 (1993)(Symbiosis)(Kangaroo)(ST-Module)
...
.l4442 equ $ + 4
	...
	db #be,#85,#22,#47,#1e,#86,#dc,#3e
	db #b8,#7d,#dc,#3e,#b8,#7d,#dc,#3e
	db #b8,#7d,#dc,#3e,#b8,#7d,#b8,#7d
	db #b8,#7d,#dc,#3e,#b8,#7d,#b8,#7d
	db #b8,#7d,#dc,#3e,#62,#46,#a2,#46
...
.l44c2 equ $ + 4
	...
	db #80,#80,#80,#80,#80,#80,#80,#80
	db #80,#80,#80,#80,#80,#80,#80,#80
	db #80,#80,#80,#80,#00,#6f,#47,#00
	db #6f,#47,#00,#73,#47,#00,#dc,#47
	db #80,#42,#47,#00,#45,#48,#00,#59
	db #48,#00,#59,#48,#00,#6d,#48,#80
	db #51,#47,#00,#bc,#48,#00,#1d,#49
	db #00,#7e,#49,#00,#9b,#49,#80,#60
	db #47,#22,#40,#04,#ff,#a2,#00,#22
	db #82,#a2,#00,#3a,#02,#02,#a2,#00
	db #a2,#00,#a5,#00,#25,#82,#a5,#00
	db #3a,#02,#02,#a5,#00,#a5,#00,#aa
	db #00,#2a,#82,#aa,#00,#3a,#02,#02
	db #aa,#00,#aa,#00,#a5,#00,#25,#82
	db #a5,#00,#3a,#02,#02,#a9,#00,#ae
	db #00,#a2,#00,#22,#82,#a2,#00,#3a
	db #02,#02,#a2,#00,#a2,#00,#a5,#00
	db #25,#82,#a5,#00,#3a,#02,#02,#a5
	db #00,#a5,#00,#a7,#00,#27,#82,#a7
	db #00,#3a,#02,#02,#a7,#00,#a7,#00
	db #a0,#00,#20,#82,#a0,#00,#3a,#02
	db #02,#a0,#00,#a5,#00,#ff,#a2,#00
	db #22,#82,#a2,#00,#3a,#02,#02,#a2
	db #00,#a2,#00,#a5,#00,#25,#82,#a5
	db #00,#3a,#02,#02,#a5,#00,#a5,#00
	db #aa,#00,#2a,#82,#aa,#00,#3a,#02
	db #02,#aa,#00,#aa,#00,#a5,#00,#25
	db #82,#a5,#00,#3a,#02,#02,#a9,#00
	db #ae,#00,#a2,#00,#22,#82,#a2,#00
	db #3a,#02,#02,#a2,#00,#a2,#00,#a5
	db #00,#25,#82,#a5,#00,#3a,#02,#02
	db #a5,#00,#a5,#00,#a7,#00,#27,#82
	db #a7,#00,#3a,#02,#02,#a7,#00,#a7
	db #00,#a0,#00,#20,#82,#a0,#00,#3a
	db #02,#02,#a0,#00,#a5,#00,#ff,#00
	db #08,#2e,#02,#01,#30,#82,#31,#82
	db #35,#9a,#2e,#82,#30,#82,#31,#82
	db #33,#92,#ff,#00,#08,#2e,#02,#01
	db #30,#82,#31,#82,#36,#9a,#2c,#82
	db #31,#82,#30,#82,#2e,#92,#ff,#ba
	db #0e,#c1,#0e,#c1,#0e,#ba,#0e,#c1
	db #0e,#ba,#0e,#bd,#0e,#bf,#0e,#42
	db #82,#41,#82,#3d,#82,#3f,#82,#41
	db #82,#c2,#0e,#41,#82,#3d,#82,#3f
	db #82,#c1,#0e,#3f,#82,#3d,#82,#3c
	db #82,#ba,#0e,#c1,#0e,#c1,#0e,#ba
	db #0e,#c1,#0e,#ba,#0e,#bd,#0e,#bf
	db #0e,#42,#82,#41,#82,#3d,#82,#3c
	db #82,#3a,#89,#ba,#0e,#bd,#0e,#bf
	db #0e,#42,#82,#41,#82,#ff,#a2,#00
	db #22,#82,#a2,#00,#22,#82,#a2,#00
	db #a2,#00,#a2,#00,#22,#82,#a2,#00
	db #22,#82,#a2,#00,#a2,#00,#a2,#00
	db #22,#82,#a2,#00,#22,#82,#a2,#00
	db #a2,#00,#a2,#00,#22,#82,#a2,#00
	db #22,#82,#a2,#00,#a2,#00,#a2,#00
	db #22,#82,#a2,#00,#22,#82,#a2,#00
	...
	db #c1,#0f,#bd,#0f,#bc,#0f,#bd,#0f
	db #3a,#8a,#41,#82,#42,#84,#3d,#82
	db #3a,#86,#42,#84,#44,#86,#41,#86
	db #3d,#84,#3a,#90,#ff,#c1,#0f,#bd
	db #0f,#bc,#0f,#bd,#0f,#3a,#8a,#41
	db #82,#42,#84,#3d,#82,#3a,#86,#42
	db #84,#44,#86,#41,#86,#3d,#84,#3a
	db #90,#ff,#08,#c3,#08,#c1,#08,#c3
...
;
.music_info
	db "X-treme Issue 2 - Music 6 (1993)(Symbiosis)(Kangaroo)",0
	db "ST-Module",0
