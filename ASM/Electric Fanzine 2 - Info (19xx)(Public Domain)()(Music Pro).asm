; Music of Electric Fanzine 2 - Info (19xx)(Public Domain)()(Music Pro)
...
.l9201 equ $ + 3
.l9200 equ $ + 2
	db #00,#00,#06,#06,#02,#1f,#00,#c6
.l920d equ $ + 7
.l920b equ $ + 5
.l9209 equ $ + 3
.l9207 equ $ + 1
	db #01,#c6,#02,#0e,#00,#15,#00,#1a
	db #00,#00,#00,#00,#00,#01,#01,#ff
	db #02,#02,#03,#03,#ff,#04,#04,#05
	db #05,#ff,#2d,#00,#55,#00,#ad,#00
	db #e3,#00,#30,#01,#48,#01,#3e,#96
	db #e0,#00,#a0,#c3,#e2,#05,#82,#1a
	db #1a,#1a,#1a,#a5,#d1,#e1,#02,#32
	db #a0,#c3,#e2,#05,#1d,#1d,#1d,#1f
	db #1f,#1f,#1f,#a5,#d1,#e1,#02,#32
	db #a0,#c3,#e2,#05,#21,#21,#21,#ff
	db #e0,#00,#a0,#c6,#e2,#05,#82,#22
	db #2e,#2e,#22,#21,#2d,#2d,#21,#1f
	db #2b,#2b,#1f,#1d,#29,#29,#1d,#21
	db #2d,#21,#2d,#2d,#21,#2d,#21,#2d
	db #2d,#21,#2d,#21,#2d,#2d,#21,#22
	db #2e,#2e,#22,#21,#2d,#2d,#21,#1f
	db #2b,#2b,#1f,#1d,#29,#29,#1d,#1a
	db #26,#1a,#26,#26,#1a,#26,#1a,#26
	db #26,#1a,#26,#1a,#26,#26,#1a,#1a
	db #26,#1a,#26,#26,#1a,#26,#1a,#26
	db #26,#1a,#26,#1a,#26,#26,#1a,#ff
	db #e0,#00,#a0,#c6,#e2,#05,#86,#3e
	db #3c,#3b,#37,#8a,#39,#86,#3e,#3c
	db #3b,#37,#8a,#39,#82,#3e,#3c,#3e
	db #40,#41,#40,#3e,#3c,#3e,#3c,#3e
	db #40,#41,#40,#3e,#3c,#3e,#3c,#3e
	db #3c,#39,#3c,#39,#37,#35,#32,#30
	db #35,#32,#32,#30,#32,#ff,#e0,#00
	db #a0,#c2,#e2,#05,#82,#4a,#48,#4a
	db #48,#4a,#48,#4a,#48,#4a,#48,#4a
	db #48,#4a,#48,#4a,#48,#4a,#4d,#4a
	db #4d,#4a,#4d,#4a,#4d,#4a,#4d,#4a
	db #4d,#4a,#4d,#4d,#4d,#4a,#48,#4a
	db #48,#4a,#48,#4a,#48,#4a,#48,#4a
	db #48,#4a,#48,#4a,#48,#4a,#48,#4a
	db #48,#4a,#48,#4a,#48,#4a,#48,#4a
	db #48,#4a,#48,#4a,#48,#c9,#e1,#07
	db #8a,#32,#ff,#e0,#00,#a0,#cd,#e1
	db #06,#82,#26,#26,#26,#26,#29,#29
	db #29,#29,#2b,#2b,#2b,#2b,#2d,#2d
	db #2d,#2d,#ff,#e0,#00,#a2,#d0,#e2
	db #00,#82,#00,#a1,#ce,#00,#a0,#cd
	db #e2,#04,#1a,#a1,#ce,#e2,#00,#00
	db #a5,#d1,#e1,#02,#32,#a2,#d0,#e2
	db #00,#00,#a1,#cf,#00,#00,#a2,#d0
	db #00,#a1,#ce,#00,#a0,#cd,#e2,#04
	db #1a,#a1,#ce,#e2,#00,#00,#a5,#d1
	db #e1,#02,#32,#a2,#d0,#e2,#00,#00
	db #a1,#cf,#00,#00,#a2,#d0,#00,#a1
	db #ce,#00,#a0,#cd,#e2,#04,#1a,#a1
	db #ce,#e2,#00,#00,#a5,#d1,#e1,#02
	db #32,#a2,#d0,#e2,#00,#00,#a1,#cf
	db #00,#00,#a2,#d0,#00,#a1,#ce,#00
	db #a0,#cd,#e2,#04,#1a,#a1,#ce,#e2
	db #00,#00,#a5,#d1,#e1,#02,#32,#a2
	db #d0,#e2,#00,#00,#a1,#cf,#00,#00
	...
	db #ff
;
;;;; MEMORY &88FF:LOAD"music":LOAD"musicinf.bin",&9200
;;;; 99 CALL &BB16:CALL &8902:RUN"pub"
;
.music_info
	db "Electric Fanzine 2 - Info (19xx)(Public Domain)()",0
	db "Music Pro",0
