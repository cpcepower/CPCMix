; Music of Disc Mac Challenge Issue 20 - Music 2 (1996)(Hypnomega)()(ST-Module)
...
.l3442 equ $ + 4
	...
	db #dc,#2e,#00,#00,#dc,#2e,#dc,#2e
	db #b8,#5d,#dc,#2e,#b8,#5d,#dc,#2e
	db #b8,#5d,#dc,#2e,#b8,#5d,#dc,#2e
	db #b8,#5d,#dc,#2e,#b8,#5d,#b8,#5d
	db #b8,#5d,#dc,#2e,#b8,#5d,#be,#65
	db #b8,#5d,#dc,#2e,#b8,#5d,#b8,#5d
	db #b8,#5d,#dc,#2e,#b8,#5d,#b8,#5d
.l34c2 equ $ + 4
	db #dc,#2e,#80,#00,#1c,#30,#7c,#30
	db #1c,#31,#c4,#31,#22,#37,#42,#37
...
;
.music_info
	db "Disc Mac Challenge Issue 20 - Music 2 (1996)(Hypnomega)()",0
	db "ST-Module",0
