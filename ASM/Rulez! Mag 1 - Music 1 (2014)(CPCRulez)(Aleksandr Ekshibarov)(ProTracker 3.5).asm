; Music of Rulez! Mag 1 - Music 1 (2014)(CPCRulez)(Aleksandr Ekshibarov)(ProTracker 3.5)
...
.l3131 equ $ + 6
	...
	db #01,#ec,#27,#cd,#1a,#2e,#ed,#43
	db #5c,#31,#21,#6b,#33,#35,#20,#0e
	db #dd,#21,#5c,#33,#01,#a7,#29,#cd
	...
	db #00,#00,#00,#00,#00,#30,#2b,#d8
	db #29,#02,#24,#00,#00,#01,#00,#00
	db #00,#00,#00,#01,#f0,#00,#06,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#30,#2b,#f2,#2a,#02,#28
	db #00,#10,#01,#00,#00,#00,#00,#00
	db #01,#f0,#03,#00,#00,#00,#00,#09
	db #44,#00,#ce,#01,#d6,#00,#05,#24
...
;
.music_info
	db "Rulez! Mag 1 - Music 1 (2014)(CPCRulez)(Aleksandr Ekshibarov)",0
	db "ProTracker 3.5",0
