; Music of X-treme Issue 1 - Music 11 (1993)(Symbiosis)(Kangaroo)(ST-Module)
...
.l44c2 equ $ + 4
	...
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#b7,#46,#00
	db #c3,#46,#00,#cf,#46,#00,#fd,#46
	db #00,#37,#47,#00,#b8,#47,#02,#cf
	db #46,#02,#fd,#46,#00,#cf,#46,#00
	db #fd,#46,#02,#37,#47,#02,#b8,#47
	db #80,#48,#46,#00,#39,#48,#00,#7b
	db #48,#00,#bd,#48,#00,#11,#49,#00
	db #66,#49,#00,#ba,#49,#02,#bd,#48
	db #02,#11,#49,#00,#bd,#48,#00,#11
	db #49,#02,#66,#49,#02,#ba,#49,#80
	db #6f,#46,#00,#0f,#4a,#00,#29,#4a
	db #00,#41,#4a,#00,#6d,#4a,#00,#9a
	db #4a,#00,#c6,#4a,#02,#41,#4a,#02
	db #6d,#4a,#00,#41,#4a,#00,#6d,#4a
	db #02,#9a,#4a,#02,#c6,#4a,#80,#96
	db #46,#00,#1a,#3f,#02,#03,#42,#82
	db #46,#82,#4b,#a0,#ff,#00,#1a,#3a
	db #02,#03,#3d,#82,#41,#82,#46,#a0
	db #ff,#46,#04,#00,#46,#84,#46,#84
	db #44,#82,#42,#82,#44,#82,#42,#82
	db #44,#82,#46,#84,#46,#82,#44,#82
	db #42,#82,#3f,#84,#3f,#84,#3f,#82
	db #42,#82,#44,#82,#42,#82,#44,#84
	db #46,#84,#44,#82,#42,#86,#ff,#46
	db #04,#00,#46,#84,#46,#84,#44,#82
	db #42,#82,#44,#82,#42,#82,#44,#82
	db #46,#84,#46,#82,#44,#82,#42,#82
	db #4b,#82,#46,#82,#42,#82,#46,#82
	db #4b,#82,#46,#82,#42,#82,#46,#82
	db #41,#82,#46,#82,#3f,#82,#46,#82
	db #3e,#82,#46,#82,#3f,#82,#3e,#82
	db #ff,#bf,#00,#ba,#00,#c1,#00,#ba
	db #00,#c2,#00,#ba,#00,#c4,#00,#ba
	db #00,#c6,#00,#ba,#00,#c4,#00,#ba
	db #00,#c2,#00,#ba,#00,#c1,#00,#ba
	db #00,#bf,#00,#ba,#00,#c1,#00,#ba
	db #00,#c2,#00,#ba,#00,#c4,#00,#ba
	db #00,#c6,#00,#ba,#00,#c4,#00,#ba
	db #00,#c2,#00,#ba,#00,#c1,#00,#ba
	db #00,#bd,#00,#b8,#00,#bf,#00,#b8
	db #00,#c1,#00,#b8,#00,#c2,#00,#b8
	db #00,#c4,#00,#b8,#00,#c2,#00,#b8
	db #00,#c1,#00,#b8,#00,#bf,#00,#b8
	db #00,#bd,#00,#b8,#00,#bf,#00,#b8
	db #00,#c1,#00,#b8,#00,#c2,#00,#b8
	db #00,#c4,#00,#b8,#00,#c2,#00,#b8
	db #00,#c1,#00,#b8,#00,#bf,#00,#b8
	db #00,#ff,#bb,#00,#b3,#00,#bd,#00
...
;
.music_info
	db "X-treme Issue 1 - Music 11 (1993)(Symbiosis)(Kangaroo)",0
	db "ST-Module",0
