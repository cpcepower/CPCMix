; Music of Landscape Demo (1993)(Bugs)()(ST-128 Module)
; Ripped by Megachur the 15/08/2011
; $VER 1.5
...
; 15/04/2018 - corrected end of data
...
.l4640
	...
	db #a4,#ff,#b2,#46,#52,#48,#a0,#48
	db #e0,#46,#60,#47,#40,#47,#1a,#06
	db #80,#47,#c0,#47,#40,#47,#18,#08
	db #a4,#df,#92,#48,#d2,#48,#40,#47
	db #e8,#09,#f2,#48,#32,#49,#80,#49
	db #e0,#47,#20,#48,#40,#47,#1a,#00
	db #a4,#ff,#76,#ff,#76,#11,#28,#00
	db #a4,#6f,#36,#00,#a4,#ff,#d2,#ff
	db #d2,#ff,#a4,#ff,#a4,#ff,#d2,#ff
	db #40,#48,#80,#48,#40,#47,#16,#0a
	db #d2,#49,#a4,#ff,#a4,#ff,#d2,#ff
