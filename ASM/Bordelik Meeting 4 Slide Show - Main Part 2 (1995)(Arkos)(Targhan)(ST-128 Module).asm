; Music of Bordelik Meeting 4 Slide Show - Main Part 2 (1995)(Arkos)(Targhan)(ST-128 Module)
...
.l4640
	...
	db #92,#00,#b2,#46,#d2,#48,#40,#47
	db #80,#47,#c0,#47,#e0,#47,#c0,#00
	db #00,#48,#40,#48,#60,#48,#1a,#06
	db #e0,#46,#80,#48,#40,#47,#1a,#06
	db #c0,#0f,#76,#ff,#06,#90,#90,#ec
	db #0c,#6d,#46,#80,#cd,#cf,#24,#80
	db #a4,#ff,#24,#49,#a4,#ff,#d2,#ff
	db #d2,#ff,#a4,#ff,#a4,#ff,#d2,#ff
	db #d2,#ff,#f2,#48,#12,#49,#d2,#ff
	db #32,#49,#a4,#ff,#a4,#ff,#d2,#ff
	db #a4,#ff,#a4,#ff,#a4,#ff,#d2,#ff
	db #a4,#ff,#a4,#ff,#a4,#ff,#d2,#ff
	db #52,#49,#d2,#ff,#d2,#ff,#00,#00
...
.l46c0
	...
	db #42,#00,#02,#ff,#46,#00,#2a,#45
	db #00,#06,#44,#00,#06,#42,#00,#04
	db #f5,#69,#7c,#03,#4d,#66,#2f,#42
	db #96,#90,#a7,#42,#6e,#f4,#a7,#a3
	db #87,#de,#43,#c8,#1e,#81,#1e,#f4
	db #a7,#8f,#87,#1e,#6e,#7b,#f8,#d0
	db #e8,#fa,#1e,#1e,#3f,#1e,#b2,#34
	db #fa,#21,#05,#00,#1a,#10,#28,#80
	db #14,#c7,#f7,#ff
;
.music_info
	db "Bordelik Meeting 4 Slide Show - Main Part 2 (1995)(Arkos)(Targhan)",0
	db "ST-128 Module",0
