; Music of Thing on a Spring (1990)(Gremlin Graphics)(Ben Daglish)()
; Ripped by Megachur the 26/06/2007
; $VER 1.5
...
;
.music_info
	db "Thing on a Spring (1990)(Gremlin Graphics)(Ben Daglish)",0
	db "",0
