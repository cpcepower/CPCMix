; Music of BabaFanz Meeting - End Part (1995)(Public Domain)()(ST-Module)
...
.l64c2 equ $ + 4
	...
	db #06,#48,#08,#f5,#05,#ff
;
.music_info
	db "BabaFanz Meeting - End Part (1995)(Public Domain)()",0
	db "ST-Module",0
