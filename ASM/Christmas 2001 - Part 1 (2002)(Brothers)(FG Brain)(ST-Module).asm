; Music of Christmas 2001 - Part 1 (2002)(Brothers)(FG Brain)(ST-Module)
...
.l43fe equ $ + 4
	db #00,#00,#00,#00,#f0,#47,#00,#01
	db #08,#09,#0c,#29,#00,#00,#00,#df
.l440c equ $ + 2
	db #89,#47,#c6,#46,#06,#47,#26,#47
	db #08,#18,#01,#1f,#66,#01,#00,#00
.l441a
	db #41,#4a,#02,#03,#09,#07,#04,#2d
.l4428 equ $ + 6
	db #00,#00,#00,#e7,#aa,#47,#86,#45
	db #86,#46,#a6,#46,#18,#07,#01,#1f
.l4436 equ $ + 4
	db #1c,#01,#00,#00,#ea,#4b,#04,#05
	db #0a,#10,#20,#00,#00,#00,#00,#ef
.l4444 equ $ + 2
	db #cb,#47,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
...
.l463a
	...
	db #cd,#09,#ca,#09,#ff,#00
;
.music_info
	db "Christmas 2001 - Part 1 (2002)(Brothers)(FG Brain)",0
	db "ST-Module",0
