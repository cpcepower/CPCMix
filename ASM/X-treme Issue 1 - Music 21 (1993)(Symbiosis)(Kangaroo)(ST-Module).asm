; Music of X-treme Issue 1 - Music 21 (1993)(Symbiosis)(Kangaroo)(ST-Module)
...
.l4442 equ $ + 4
	...
	db #51,#3d,#f0,#30,#62,#45,#a2,#45
	db #c2,#45,#08,#18,#e2,#45,#22,#46
	db #c2,#45,#00,#00,#b7,#7d,#da,#3e
	db #b7,#7d,#dc,#3e,#b9,#7d,#ba,#7d
	db #b9,#7d,#dc,#3e,#b7,#7d,#b6,#7d
	db #b7,#7d,#dc,#3e,#de,#84,#ba,#7d
	db #b9,#7d,#dc,#3e,#b7,#7d,#b6,#7d
.l44c2 equ $ + 4
...
.l4642 equ $ + 4
	db #01,#00,#00,#00,#00,#78,#46,#00
	db #86,#46,#00,#86,#46,#00,#96,#46
.l4654 equ $ + 6
	db #00,#86,#46,#80,#42,#46,#00,#a4
	db #46,#00,#d8,#46,#00,#f8,#46,#00
	db #10,#47,#00,#4e,#47,#80,#54,#46
.l4666
	db #00,#88,#47,#00,#da,#47,#00,#da
	db #47,#00,#88,#47,#00,#da,#47,#80
	db #66,#46,#46,#18,#09,#45,#88,#43
	...
	db #02,#01,#26,#02,#0a,#ff,#41,#82
	db #3f,#82,#3a,#82,#3e,#82,#3f,#82
	db #41,#82,#46,#82,#ff,#27,#20,#c0
	db #16,#26,#20,#c0,#18,#ff,#29,#20
	db #c0,#14,#27,#20,#c0,#16,#ff,#2a
	db #20,#c0,#13,#2c,#10,#c0,#11,#22
	db #10,#c3,#1e,#ff,#27,#20,#c0,#16
	db #26,#20,#c0,#18,#ff,#29,#20,#c0
	db #14,#27,#20,#c0,#16,#ff,#2a,#20
	db #c0,#13,#2c,#10,#c0,#11,#22,#10
	db #c3,#1e,#ff,#27,#20,#c0,#16,#26
	db #20,#c0,#18,#ff,#29,#1a,#c0,#14
	db #29,#82,#2a,#02,#c0,#13,#29,#02
	db #c0,#14,#27,#20,#c0,#16,#ff,#2a
	db #20,#c0,#13,#2c,#10,#c0,#11,#22
	db #10,#c3,#1e,#ff,#00,#01,#33,#02
	db #13,#36,#02,#03,#3a,#82,#36,#82
	db #3f,#82,#3a,#82,#36,#82,#3a,#82
	db #33,#82,#36,#82,#3a,#82,#36,#82
	db #3f,#82,#3a,#82,#36,#82,#3a,#82
	db #32,#82,#35,#82,#3a,#82,#35,#82
	db #3e,#82,#3a,#82,#35,#82,#3a,#82
	db #32,#82,#35,#82,#3a,#82,#35,#82
	db #3e,#82,#3a,#82,#35,#82,#ba,#03
	db #ff,#00,#01,#32,#02,#03,#35,#82
	db #3a,#82,#35,#82,#3e,#82,#3a,#82
	db #35,#82,#3a,#82,#32,#82,#35,#82
	db #3a,#82,#35,#82,#3e,#82,#3a,#82
	db #35,#82,#3a,#82,#33,#82,#36,#82
	db #3a,#82,#36,#82,#3f,#82,#3a,#82
	db #36,#82,#3a,#82,#33,#82,#36,#82
	db #3a,#82,#36,#82,#3f,#82,#3a,#82
	db #36,#82,#ba,#03,#ff,#00,#01,#36
	db #02,#03,#3a,#82,#3f,#82,#41,#82
	db #42,#82,#41,#82,#3f,#82,#3a,#82
	db #36,#82,#3a,#82,#3f,#82,#41,#82
	db #42,#82,#41,#82,#3f,#82,#3a,#82
	db #38,#82,#3c,#82,#3f,#82,#41,#82
	db #42,#82,#41,#82,#3f,#82,#38,#82
	db #42,#82,#41,#82,#3f,#82,#3a,#82
	db #3e,#82,#3f,#82,#41,#82,#c6,#03
	db #ff,#2e,#1e,#01,#2e,#82,#2e,#9c
	db #3a,#04,#02,#ff,#2e,#1e,#01,#2e
	db #82,#2e,#9c,#3a,#04,#02,#ff,#2e
	db #08,#01,#3a,#06,#02,#2e,#02,#01
	db #2e,#84,#2e,#84,#3a,#03,#02,#3a
	db #83,#3a,#82,#2e,#08,#01,#3a,#06
	db #02,#2e,#02,#01,#2e,#86,#2e,#82
	db #3a,#04,#02,#3a,#84,#ff,#2e,#08
	db #01,#3a,#06,#02,#2e,#02,#01,#2e
	db #84,#2e,#82,#3a,#02,#02,#3a,#83
	db #3a,#83,#3a,#82,#2e,#06,#01,#2e
	db #82,#3a,#06,#02,#2e,#04,#01,#2e
	db #84,#2e,#82,#3a,#04,#02,#3a,#84
	db #ff,#2e,#08,#01,#3a,#06,#02,#2e
	db #02,#01,#2e,#84,#2e,#82,#3a,#02
	db #02,#3a,#83,#3a,#83,#3a,#82,#2e
	db #08,#01,#3a,#06,#02,#2e,#02,#01
	db #39,#83,#37,#83,#33,#82,#32,#83
	db #30,#83,#2e,#82,#ff,#ae,#01,#ed
	db #04,#ed,#04,#ed,#04,#ba,#02,#ed
	db #04,#ae,#01,#ed,#04,#ae,#01,#ed
	db #04,#ed,#04,#ae,#01,#ba,#02,#ed
	db #04,#ae,#01,#ed,#04,#ae,#01,#ed
	db #04,#ed,#04,#ed,#04,#ba,#02,#ed
	db #04,#ae,#01,#ed,#04,#ae,#01,#ed
	db #04,#ed,#04,#ae,#01,#ba,#02,#ed
	...
	db #04,#ae,#01,#ed,#04,#ae,#01,#ed
	db #04,#ed,#04,#ae,#01,#ba,#02,#ed
	db #04,#ae,#01,#ed,#04,#ff,#ae,#01
	db #ed,#04,#ed,#04,#ed,#04,#ba,#02
	db #ed,#04,#ae,#01,#ed,#04,#ae,#01
	db #ed,#04,#ed,#04,#ae,#01,#ba,#02
	db #ed,#04,#ae,#01,#ed,#04,#ae,#01
	db #ed,#04,#ed,#04,#ed,#04,#ba,#02
	db #ed,#04,#ae,#01,#ed,#04,#ae,#01
	db #ed,#04,#ed,#04,#ae,#01,#ba,#02
	...
	db #ed,#04,#ae,#01,#ed,#04,#ae,#01
	db #ed,#04,#ed,#04,#ae,#01,#ba,#02
	db #ed,#04,#ae,#01,#ed,#04,#ff
;
.music_info
	db "X-treme Issue 1 - Music 21 (1993)(Symbiosis)(Kangaroo)",0
	db "ST-Module",0
