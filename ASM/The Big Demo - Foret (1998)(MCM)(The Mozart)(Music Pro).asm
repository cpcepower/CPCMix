; Music of The Big Demo - Foret (1998)(MCM)(The Mozart)(Music Pro)
...
.l8004 equ $ + 2
.l8002
	db #cd,#00,#cd,#01,#42,#00,#66,#00
.l800c equ $ + 2
.l800a
	db #88,#00,#cd,#02,#d3,#02,#f0,#02
	db #04,#03,#57,#03,#76,#03,#cf,#03
	db #41,#04,#65,#04,#79,#04,#fd,#04
	db #69,#05,#8d,#05,#ac,#05,#ec,#05
	db #f2,#05,#59,#06,#7b,#06,#a0,#06
	db #d8,#06,#06,#07,#53,#07,#87,#07
	db #bb,#07,#fb,#07,#fe,#07,#01,#08
	db #00,#01,#00,#01,#04,#04,#04,#04
	db #03,#05,#01,#01,#03,#06,#01,#01
	db #04,#05,#18,#05,#01,#01,#01,#01
	db #01,#01,#04,#04,#04,#04,#05,#19
	db #05,#06,#1a,#ff,#0e,#0e,#0b,#0b
	db #0c,#0c,#0d,#0d,#09,#0a,#0d,#0a
	db #0f,#0d,#0d,#0a,#18,#0a,#0e,#0e
	db #0e,#0e,#0b,#0b,#0c,#0c,#0d,#0d
	db #0a,#19,#0a,#0f,#1a,#ff,#12,#12
	db #12,#12,#12,#12,#12,#12,#12,#12
	db #12,#13,#14,#14,#14,#14,#14,#14
	db #14,#17,#12,#13,#14,#14,#14,#14
	db #14,#14,#14,#15,#12,#16,#12,#16
	db #14,#14,#14,#16,#14,#14,#14,#16
	db #16,#16,#16,#16,#16,#16,#12,#17
	db #12,#16,#16,#12,#12,#13,#14,#14
	db #14,#13,#14,#14,#14,#16,#14,#14
	db #14,#15,#ff,#0f,#00,#0f,#00,#0f
	...
	db #00,#01,#00,#01,#06,#06,#ff,#01
	db #00,#01,#00,#02,#07,#02,#ff,#02
	db #00,#0c,#ff,#01,#0f,#05,#ff,#04
	db #00,#83,#9e,#01,#0d,#02,#ff,#02
	db #00,#0b,#ff,#01,#0f,#01,#fb,#08
	db #00,#0a,#ff,#01,#0f,#01,#00,#03
	db #fb,#09,#00,#01,#0a,#01,#00,#03
	db #00,#01,#00,#01,#0f,#02,#00,#03
	db #fb,#01,#00,#01,#0d,#02,#00,#04
	db #fc,#04,#ff,#01,#0b,#02,#00,#04
	db #fd,#01,#00,#01,#0e,#01,#00,#01
	...
	db #fe,#01,#fd,#01,#00,#03,#0c,#be
	db #e9,#01,#ef,#01,#00,#82,#02,#82
	db #82,#82,#02,#08,#00,#01,#01,#01
	...
	db #fe,#01,#01,#08,#00,#01,#01,#01
	db #01,#01,#01,#01,#00,#01,#00,#01
	db #01,#01,#ff,#c0,#e1,#00,#8a,#00
	db #ff,#c0,#e1,#00,#88,#00,#82,#00
	db #d6,#e1,#01,#46,#3d,#32,#c6,#e1
	db #02,#80,#44,#3d,#46,#c5,#3f,#42
	db #c4,#4b,#3d,#c3,#3f,#ff,#c0,#e1
	db #00,#88,#00,#82,#00,#c1,#e1,#01
	db #46,#3f,#32,#32,#c0,#e1,#00,#86
	db #00,#ff,#d1,#e1,#03,#84,#35,#82
	db #33,#35,#84,#36,#82,#33,#84,#35
	db #82,#35,#33,#35,#84,#36,#82,#33
	db #84,#35,#82,#35,#33,#35,#84,#36
	db #82,#33,#84,#31,#85,#2e,#c0,#e1
	db #00,#86,#00,#d1,#e1,#03,#84,#31
	db #82,#30,#31,#84,#33,#82,#30,#84
	db #31,#82,#31,#30,#31,#84,#33,#82
	db #30,#84,#31,#82,#31,#30,#31,#84
	db #33,#82,#2c,#84,#35,#85,#31,#c0
	db #e1,#00,#86,#00,#ff,#d1,#e1,#03
	db #84,#41,#82,#3f,#84,#41,#42,#3f
	db #82,#3d,#84,#3f,#3d,#3f,#41,#82
	db #3f,#84,#41,#42,#3f,#82,#3d,#84
	db #3f,#3d,#3c,#ff,#d8,#e1,#03,#84
	db #41,#82,#3f,#41,#84,#42,#82,#3f
	db #84,#41,#82,#41,#3f,#41,#84,#42
	db #82,#3f,#84,#41,#82,#41,#3f,#41
	db #84,#42,#82,#3f,#84,#3d,#85,#3a
	db #c0,#e1,#00,#86,#00,#d8,#e1,#03
	db #84,#3d,#82,#3c,#3d,#84,#3f,#82
	db #3c,#84,#3d,#82,#3d,#3c,#3d,#84
	db #3f,#82,#3c,#84,#3d,#82,#3d,#3c
	db #3d,#84,#3f,#82,#38,#84,#41,#85
	db #3d,#c0,#e1,#00,#82,#00,#d6,#e1
	db #01,#46,#3f,#3a,#ff,#d8,#e1,#03
	db #82,#41,#c3,#e1,#02,#49,#de,#e1
	db #03,#3f,#41,#84,#42,#82,#3f,#41
	db #c3,#e1,#02,#27,#27,#de,#e1,#03
	db #3f,#41,#42,#c3,#e1,#02,#34,#de
	db #e1,#03,#3f,#41,#c4,#80,#31,#30
	db #2e,#2c,#de,#82,#3f,#41,#42,#cc
	db #e1,#05,#4e,#d8,#e1,#03,#3f,#84
	db #3d,#82,#3a,#cc,#22,#25,#29,#30
	db #2d,#2e,#d8,#84,#3d,#82,#3c,#3d
	db #84,#3f,#82,#3c,#3d,#cc,#22,#29
	db #d8,#3c,#3d,#84,#3f,#82,#3c,#3d
	db #cc,#29,#2e,#db,#3c,#3d,#84,#3f
	db #82,#38,#84,#41,#de,#3d,#c0,#e1
	db #00,#00,#82,#00,#00,#00,#ff,#c2
	db #e1,#00,#82,#1b,#c3,#1b,#c4,#1b
	db #c5,#1b,#c2,#1b,#c3,#1f,#c4,#1b
	db #c5,#1b,#c2,#1b,#c4,#1b,#c5,#1b
	db #c2,#1b,#c3,#1b,#c4,#1b,#c5,#1b
	db #c2,#1b,#ff,#c1,#e1,#00,#82,#19
	db #c2,#19,#c1,#1d,#c2,#20,#c1,#1f
	db #c2,#1f,#c1,#1b,#c2,#18,#ff,#c1
	db #e1,#00,#82,#19,#c2,#19,#c1,#19
	db #c2,#19,#c1,#19,#c2,#19,#c1,#19
	db #c2,#19,#c1,#19,#c2,#19,#c1,#19
	db #c2,#19,#c1,#19,#c2,#19,#c1,#19
	db #c2,#19,#c1,#19,#c2,#19,#c1,#19
	db #c2,#19,#c1,#19,#c2,#19,#c1,#19
	db #c2,#19,#c1,#16,#c2,#16,#c1,#16
	db #c2,#16,#c1,#16,#c2,#16,#c1,#16
	db #c2,#16,#c1,#16,#c2,#16,#c1,#16
	db #c2,#16,#c1,#16,#c2,#16,#c1,#16
	db #c2,#16,#c1,#16,#c2,#16,#c1,#16
	db #c2,#16,#c1,#16,#c2,#16,#c1,#16
	db #c2,#16,#c1,#16,#c2,#16,#c1,#16
	db #c2,#16,#c1,#14,#c2,#14,#c1,#14
	db #c2,#14,#c1,#19,#c2,#19,#c1,#19
	db #c2,#19,#c1,#19,#c2,#19,#c1,#19
	db #c2,#19,#ff,#d2,#e1,#03,#82,#38
	db #c1,#e1,#00,#19,#db,#e1,#03,#36
	db #38,#39,#c1,#e1,#04,#19,#db,#e1
	db #03,#36,#38,#c1,#19,#de,#38,#36
	db #38,#39,#c1,#19,#de,#36,#38,#c1
	db #19,#de,#38,#36,#38,#39,#c1,#19
	db #de,#36,#35,#c1,#16,#de,#31,#c1
	db #16,#16,#16,#16,#16,#16,#de,#35
	db #c1,#16,#de,#33,#35,#36,#c1,#16
	db #de,#33,#35,#c1,#16,#de,#35,#33
	db #35,#36,#c1,#16,#de,#33,#35,#c1
	db #16,#de,#35,#33,#35,#36,#c1,#16
	db #de,#33,#38,#c1,#19,#de,#35,#c1
	db #19,#19,#19,#19,#19,#19,#ff,#c1
	db #e1,#00,#82,#19,#c2,#19,#c3,#19
	db #c4,#19,#c1,#19,#c2,#19,#c3,#19
	db #c4,#19,#c1,#19,#c3,#19,#c4,#19
	db #c1,#19,#c2,#19,#c3,#19,#c4,#19
	db #c1,#19,#ff,#d1,#e1,#03,#84,#3d
	db #82,#3c,#84,#3d,#3f,#3c,#82,#3a
	db #84,#3c,#3a,#3c,#3d,#82,#3c,#84
	db #3d,#3f,#3c,#82,#3a,#84,#3c,#3a
	db #38,#ff,#d1,#e1,#03,#82,#31,#dd
	db #19,#db,#30,#31,#dd,#19,#db,#33
	db #dd,#14,#de,#30,#dd,#20,#de,#2e
	db #30,#dd,#1b,#de,#2e,#dd,#1e,#de
	db #30,#dd,#14,#de,#25,#dd,#19,#de
	db #30,#31,#dd,#1d,#de,#33,#dd,#1e
	db #de,#30,#dd,#20,#de,#2e,#30,#dd
	db #20,#de,#2e,#dd,#14,#de,#2c,#dd
	db #14,#ff,#c0,#e1,#00,#8a,#00,#ff
	db #de,#e1,#03,#82,#38,#dd,#19,#de
	db #36,#38,#3a,#dd,#20,#de,#36,#38
	db #dd,#19,#19,#de,#36,#38,#3a,#dd
	db #20,#de,#36,#38,#dd,#19,#14,#de
	db #36,#38,#3a,#dd,#1e,#de,#36,#35
	db #dd,#22,#de,#31,#dd,#16,#22,#16
	db #22,#16,#22,#de,#35,#dd,#16,#de
	db #33,#35,#36,#dd,#11,#de,#33,#35
	db #dd,#16,#22,#de,#33,#35,#36,#dd
	db #1d,#de,#33,#35,#dd,#22,#16,#de
	db #33,#35,#36,#dd,#14,#de,#3c,#3d
	db #dd,#19,#de,#84,#35,#c0,#e1,#00
	db #82,#00,#00,#00,#00,#00,#ff,#a1
	db #d3,#e1,#00,#82,#00,#00,#d4,#00
	db #d5,#00,#d3,#00,#00,#d4,#00,#d5
	db #00,#d3,#00,#d4,#00,#d5,#00,#d3
	db #00,#00,#d4,#00,#d5,#00,#d3,#00
	db #ff,#a1,#c6,#e1,#00,#82,#00,#c5
	db #00,#c4,#00,#c3,#00,#c5,#00,#c4
	db #00,#c3,#00,#c2,#00,#c4,#00,#c3
	db #00,#c2,#00,#c4,#00,#c3,#00,#c2
	db #00,#c1,#00,#c3,#00,#ff,#a0,#c1
	db #e1,#00,#82,#01,#a1,#d3,#00,#d4
	db #00,#d5,#00,#a6,#dd,#e1,#01,#00
	db #a1,#d3,#e1,#00,#00,#d4,#00,#d5
	db #00,#a0,#c1,#e1,#03,#01,#a1,#d3
	db #e1,#00,#00,#d4,#00,#d5,#00,#a5
	db #dd,#e1,#01,#00,#a1,#d3,#e1,#00
	db #00,#d4,#00,#d5,#00,#ff,#a0,#c1
	db #e1,#00,#82,#01,#a1,#d3,#00,#d4
	db #00,#d5,#00,#a5,#dd,#e1,#01,#00
	db #a1,#d3,#e1,#00,#00,#d4,#00,#d5
	db #00,#a0,#c1,#01,#a1,#d3,#00,#e3
	db #01,#5f,#dd,#e1,#01,#50,#49,#00
...
;
.music_info
	db "The Big Demo - Foret (1998)(MCM)(The Mozart)",0
	db "Music Pro",0
