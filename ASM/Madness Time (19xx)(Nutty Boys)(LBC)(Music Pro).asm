; Music of Madness Time (19xx)(Nutty Boys)(LBC)(Music Pro)
...
music_adr				equ #8900
	...
	jp l90ed	; init play music interrupt
	jp l90df	; stop play music interrupt
;
.init_music
.l8906		; init music
;
...
;
.music_info
	db "Madness Time (19xx)(Nutty Boys)(LBC)",0
	db "Music Pro",0
