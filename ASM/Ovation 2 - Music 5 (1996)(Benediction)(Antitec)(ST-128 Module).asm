; Music of Ovation 2 - Music 5 (1996)(Benediction)(Antitec)(ST-128 Module)
...
.l866e equ $ + 6
.l8668
	db #0e,#89,#26,#89,#3e,#89,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#0e,#c7
	db #4e,#c7,#6e,#c7,#00,#00,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#0e,#07
	db #4e,#07,#6e,#07,#00,#00,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#0e,#87
	db #4e,#87,#6e,#87,#00,#00,#8e,#87
	db #ce,#87,#ee,#87,#18,#07,#0e,#88
	db #4e,#88,#ee,#87,#18,#07,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#0e,#07
	db #ae,#08,#2e,#08,#08,#00,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#6e,#88
	db #ae,#88,#ce,#88,#00,#00,#e5,#e5
.l86ee equ $ + 6
	db #e5,#e5,#e5,#e5,#e5,#e5,#ee,#88
	db #6e,#c9,#e5,#e5,#e5,#e5,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#e5,#e5
	db #e5,#e5,#e5,#e5,#e5,#e5,#00,#00
	...
	db #89,#00,#83,#89,#00,#56,#89,#00
	db #86,#89,#00,#b3,#89,#00,#56,#89
	db #00,#86,#89,#80,#0e,#89,#00,#e5
	db #89,#00,#e5,#89,#00,#b7,#89,#00
	db #f8,#89,#00,#26,#8a,#00,#b7,#89
	db #00,#f8,#89,#80,#26,#89,#00,#57
	db #8a,#00,#57,#8a,#00,#57,#8a,#00
	db #57,#8a,#00,#57,#8a,#00,#57,#8a
	db #00,#57,#8a,#80,#3e,#89,#0f,#50
	db #44,#80,#02,#49,#80,#02,#4b,#80
	db #03,#44,#80,#02,#49,#80,#02,#4b
	db #80,#11,#44,#80,#02,#49,#80,#02
	db #4b,#80,#03,#44,#80,#02,#4c,#80
	db #02,#4b,#80,#03,#49,#80,#02,#44
	db #80,#07,#ff,#00,#38,#ff,#0f,#50
	db #49,#80,#02,#4e,#80,#02,#50,#80
	db #03,#49,#80,#02,#4e,#80,#02,#50
	db #80,#11,#49,#80,#02,#4e,#80,#02
	db #50,#80,#03,#49,#80,#02,#51,#80
	db #02,#50,#80,#03,#4e,#80,#02,#49
	db #80,#07,#ff,#0f,#00,#38,#ff,#38
	db #80,#05,#3d,#80,#02,#40,#80,#02
	db #3d,#80,#05,#44,#80,#05,#40,#80
	db #02,#3d,#80,#02,#40,#80,#05,#38
	db #80,#05,#3d,#80,#02,#40,#80,#02
	db #3d,#80,#05,#44,#80,#05,#40,#80
	db #02,#38,#80,#07,#ff,#49,#70,#0e
	db #44,#70,#05,#49,#70,#02,#4b,#70
	db #05,#49,#70,#02,#44,#70,#1c,#ff
	db #36,#80,#05,#39,#80,#02,#3d,#80
	db #02,#39,#80,#05,#42,#80,#05,#3d
	db #80,#02,#39,#80,#02,#3d,#80,#05
	db #36,#80,#05,#39,#80,#02,#3d,#80
	db #02,#39,#80,#05,#42,#80,#05,#3d
	db #80,#02,#36,#80,#07,#ff,#38,#80
	db #05,#3d,#80,#02,#40,#80,#02,#3d
	db #80,#05,#44,#80,#05,#40,#80,#02
	db #3d,#80,#02,#40,#80,#05,#38,#80
	db #05,#3d,#80,#02,#40,#80,#02,#3d
	db #80,#05,#44,#80,#05,#40,#80,#02
	db #3d,#80,#02,#40,#80,#05,#ff,#34
	db #e0,#05,#34,#e0,#02,#34,#60,#07
...
;
.music_info
	db "Ovation 2 - Music 5 (1996)(Benediction)(Antitec)",0
	db "ST-128 Module",0
