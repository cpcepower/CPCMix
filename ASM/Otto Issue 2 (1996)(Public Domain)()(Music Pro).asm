; Music of Otto Issue 2 (1996)(Public Domain)()(Music Pro)
...
music_adr				equ #8900
	...
	jp l90ed	; init interrupt music
	jp l90df	; stop interrupt music
;
.init_music
.l8906
;
...
.l9207 equ $ + 1
	...
	db #01,#fe,#01,#01,#08,#00,#01,#01
	db #01,#01,#01,#01,#01,#00,#01,#00
	db #01,#01,#01,#ff,#00,#00
;
.music_info
	db "Otto Issue 2 (1996)(Public Domain)()",0
	db "Music Pro",0
