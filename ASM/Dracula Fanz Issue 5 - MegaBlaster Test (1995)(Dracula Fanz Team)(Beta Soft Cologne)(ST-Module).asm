; Music of Dracula Fanz Issue 5 - MegaBlaster Test (1995)(Dracula Fanz Team)(Beta Soft Cologne)(ST-Module)
...
.l43da equ $ + 4
	db #00,#00,#00,#00,#84,#48,#00,#01
	db #08,#08,#02,#35,#00,#00,#00,#df
.l43e8 equ $ + 2
	db #a8,#47,#e2,#46,#22,#47,#42,#47
	db #00,#00,#03,#1d,#77,#00,#82,#47
.l43f6
	db #b3,#48,#02,#03,#09,#05,#0c,#39
.l4404 equ $ + 6
	db #00,#00,#00,#e7,#de,#47,#62,#46
	db #a2,#46,#c2,#46,#14,#0c,#03,#1d
.l4412 equ $ + 4
	db #8e,#00,#00,#00,#9e,#4a,#04,#05
	db #0a,#00,#04,#30,#00,#00,#00,#ef
.l4420 equ $ + 2
	db #14,#48,#e2,#44,#22,#45,#42,#45
	db #00,#00,#03,#1d,#ef,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
...
.l44c2 equ $ + 4
	...
	db #00,#04,#ed,#49,#c1,#ed,#49,#c1
	db #31,#1c,#00,#fb,#c9,#8c,#7f,#00
...
.l480e
	...
	db #cb,#00,#ca,#00,#ff,#f0,#51,#d1
	db #1e,#4e,#98,#27,#c8,#85,#4b,#af
	db #c2,#63,#c1,#c1,#4b,#89,#c3,#7f
	db #00,#10,#8c,#f0,#c2,#e0,#d2,#44
	db #a2,#0f,#c2,#d2,#0f,#44,#5a,#24
	db #c6,#cc,#3e,#93,#93,#c2,#33,#7f
	db #8c,#37,#8a,#5a,#ca,#f0,#c0,#5a
	db #d2,#4b,#5a,#5a,#0f,#5a,#cc,#44
	db #00,#08,#83,#b1,#c4,#c0,#c3,#bb
	db #c0,#44,#3c,#12,#c7,#81,#16,#00
	db #00,#40,#01,#42,#44,#d0,#07,#84
	db #33,#17,#c3,#93,#1b,#33,#46,#00
	db #08,#c7,#62,#02,#00,#42,#03,#3c
	db #af,#1f,#c1,#00,#44,#00,#08,#c4
	db #03,#3c,#00,#03,#46,#00,#10,#c2
	db #80,#00,#45,#21,#00,#cd,#00,#05
	db #41,#c3,#82,#0a,#c3,#50,#41,#82
	db #5a,#0a,#50,#84,#d2,#c3,#33,#33
	db #32,#88,#30,#c2,#cc,#3f,#44,#f5
	db #1f,#c5,#15,#6e,#30,#40,#02,#44
	db #e2,#07,#c1,#42,#45,#80,#0f,#c3
	db #c2,#d5,#0b,#4c,#a0,#07,#45,#ff
	db #07,#c2,#00,#42,#21,#45,#00,#10
	db #c4,#80,#00,#42,#c3,#84,#33,#c1
	db #41,#83,#f0,#45,#04,#10,#c5,#f0
	db #a0,#d2,#e1,#d2,#47,#08,#10,#c8
	db #50,#92,#64,#3f,#3f,#9d,#6e,#9d
	db #44,#43,#20,#c8,#15,#cc,#6e,#64
	db #6e,#64,#6e,#30,#8a,#33,#44,#4a
	db #00,#c1,#03,#83,#00,#47,#68,#08
	db #98,#33,#84,#93,#c2,#fb,#ff,#83
	db #fb,#c5,#ff,#d7,#f7,#fb,#af,#86
	db #fb,#c4,#ff

;
.music_info
	db "Dracula Fanz Issue 5 - MegaBlaster Test (1995)(Dracula Fanz Team)(Beta Soft Cologne)",0
	db "ST-Module",0
