; Music of Acid Music Box 3 ADSPart (1995)(Acid)(ADS)(ST-128 Module)
...
.l4640 equ $ + 6
.l463a
	db #a0,#4a,#c1,#4a,#e2,#4a,#e0,#46
	db #20,#47,#40,#47,#80,#00,#60,#47
	db #a0,#47,#c0,#47,#00,#00,#d2,#ff
	db #d2,#48,#12,#49,#40,#48,#e0,#47
	db #20,#48,#40,#48,#14,#0c,#d2,#ff
	db #a4,#ff,#76,#ff,#a4,#ff,#60,#48
	db #a0,#48,#c0,#48,#09,#00,#a4,#ff
	db #76,#ff,#76,#ff,#a4,#ff,#60,#48
	db #e0,#48,#40,#48,#00,#00,#00,#49
	db #40,#49,#40,#48,#40,#00,#60,#49
	db #a0,#49,#c0,#49,#00,#00,#d2,#ff
	db #a4,#ff,#a4,#ff,#d2,#ff,#a4,#ff
	db #a4,#ff,#a4,#ff,#d2,#ff,#a4,#ff
	db #a4,#ff,#a4,#ff,#d2,#ff,#e0,#49
...
.l46c0 equ $ + 6
	...
	db #0e,#0e,#0e,#0e,#0e,#0e,#0e,#0e
	db #0e,#0e,#0e,#0e,#0e,#0e,#0e,#0e
	db #0e,#0e,#0e,#0e,#0e,#0e,#00,#8c
	db #4b,#00,#03,#4b,#00,#03,#4b,#00
	db #03,#4b,#00,#11,#4b,#00,#11,#4b
	db #00,#92,#4b,#00,#92,#4b,#00,#11
	db #4b,#00,#92,#4b,#80,#a6,#4a,#00
	db #c3,#4c,#00,#fe,#4c,#00,#07,#4c
	db #00,#07,#4c,#00,#42,#4c,#00,#42
	db #4c,#00,#39,#4d,#00,#39,#4d,#00
	db #42,#4c,#00,#39,#4d,#80,#c7,#4a
	db #00,#29,#4e,#00,#29,#4e,#00,#7f
	db #4d,#00,#7f,#4d,#00,#0d,#4e,#00
	db #0d,#4e,#00,#7f,#4d,#00,#7f,#4d
	db #00,#0d,#4e,#00,#7f,#4d,#80,#e8
	db #4a,#34,#dd,#05,#10,#2f,#d0,#10
	db #32,#d0,#10,#2d,#d0,#10,#ff,#40
	db #00,#02,#40,#50,#02,#40,#00,#02
	db #40,#50,#02,#40,#00,#02,#40,#50
	db #02,#40,#00,#02,#c0,#00,#c0,#00
	db #40,#00,#02,#40,#50,#02,#40,#00
	db #02,#40,#50,#02,#40,#00,#02,#40
	db #50,#02,#40,#00,#02,#c0,#00,#c0
	db #00,#40,#00,#02,#40,#50,#02,#40
	db #00,#02,#40,#50,#02,#40,#00,#02
	db #40,#50,#02,#40,#00,#02,#40,#50
	db #02,#34,#9b,#12,#34,#9b,#12,#34
	db #9b,#12,#34,#9b,#12,#34,#9b,#11
	db #34,#9b,#11,#34,#9b,#11,#34,#9b
	db #11,#34,#9b,#10,#34,#9b,#10,#34
	db #9b,#10,#34,#9b,#10,#34,#9b,#10
	db #34,#9b,#10,#34,#9b,#10,#34,#9b
	db #10,#ff,#0d,#06,#01,#fe,#3f,#ff
	db #23,#80,#02,#a3,#80,#a3,#80,#2f
	db #80,#02,#a3,#80,#2f,#80,#02,#a3
	db #80,#af,#80,#a3,#80,#af,#80,#a3
	db #80,#af,#80,#a3,#80,#23,#80,#02
	db #a3,#80,#a3,#80,#2f,#80,#02,#a3
	db #80,#2f,#80,#02,#a3,#80,#af,#80
	db #a3,#80,#af,#80,#a3,#80,#af,#80
	db #a3,#80,#1f,#80,#02,#9f,#80,#9f
	db #80,#2b,#80,#02,#9f,#80,#2b,#80
	db #02,#9f,#80,#ab,#80,#9f,#80,#ab
	db #80,#9f,#80,#ab,#80,#9f,#80,#1f
	db #80,#02,#9f,#80,#9f,#80,#2b,#80
	db #02,#9f,#80,#2b,#80,#02,#9f,#80
	db #ab,#80,#9f,#80,#ab,#80,#9f,#80
	db #ab,#80,#9f,#80,#ff,#4c,#30,#0a
	db #cc,#30,#ca,#30,#cc,#30,#ca,#30
	db #cc,#30,#ca,#30,#47,#30,#0a,#45
	db #30,#02,#47,#30,#02,#45,#30,#02
	db #4a,#30,#0a,#47,#30,#02,#4a,#30
	db #02,#4c,#30,#02,#45,#30,#08,#c4
	db #30,#c5,#30,#c6,#30,#c7,#30,#c8
	db #30,#c9,#30,#ca,#30,#cb,#30,#ff
	db #b4,#30,#c0,#30,#b4,#30,#c0,#30
	db #c0,#30,#c0,#30,#b4,#30,#c0,#30
	db #b4,#30,#b4,#30,#c0,#30,#c0,#30
	db #b4,#30,#c0,#30,#c0,#30,#c0,#30
	db #b7,#30,#c3,#30,#b7,#30,#c3,#30
	db #c3,#30,#c3,#30,#b9,#30,#c5,#30
	db #c5,#30,#b7,#30,#c3,#30,#c3,#30
	db #b4,#30,#c0,#30,#c0,#30,#c0,#30
	db #b4,#30,#c0,#30,#b4,#30,#c0,#30
	db #c0,#30,#c0,#30,#b4,#30,#c0,#30
	db #b4,#30,#b4,#30,#c0,#30,#c0,#30
	...
	db #c5,#30,#b7,#30,#c3,#30,#c3,#30
	db #b4,#30,#c0,#30,#c0,#30,#c0,#30
	db #ff,#40,#e0,#0a,#c0,#e0,#be,#e0
	db #c0,#e0,#be,#e0,#c0,#e0,#be,#e0
	db #3b,#e0,#0a,#39,#e0,#02,#3b,#e0
	db #02,#39,#e0,#02,#3e,#e0,#0a,#3b
	db #e0,#02,#3e,#e0,#02,#40,#e0,#02
	db #39,#e0,#08,#b8,#e0,#b9,#e0,#ba
	db #e0,#bb,#e0,#bc,#e0,#bd,#e0,#be
	db #e0,#bf,#e0,#ff,#4c,#70,#0a,#cc
	db #70,#ca,#70,#cc,#70,#ca,#70,#cc
	db #70,#ca,#70,#47,#70,#0a,#45,#70
	db #02,#47,#70,#02,#45,#70,#02,#4a
	db #70,#0a,#47,#70,#02,#4a,#70,#02
	db #4c,#70,#02,#45,#70,#08,#c4,#70
	db #c5,#70,#c6,#70,#c7,#70,#c8,#70
	db #c9,#70,#ca,#70,#cb,#70,#ff,#3b
	db #30,#12,#bb,#30,#c7,#30,#45,#30
	db #02,#43,#30,#02,#45,#30,#02,#43
	db #30,#02,#c2,#30,#40,#30,#03,#43
	db #30,#10,#53,#8b,#15,#55,#8b,#15
	db #56,#8b,#15,#fe,#01,#5a,#8b,#15
	db #fe,#01,#5a,#8b,#15,#fe,#01,#58
	db #8b,#15,#fe,#01,#56,#8b,#15,#fe
	db #01,#55,#8b,#15,#fe,#01,#53,#8b
	db #15,#51,#8b,#15,#ff,#40,#10,#02
	db #40,#5b,#10,#40,#5b,#13,#40,#00
	db #02,#40,#5b,#10,#40,#5b,#13,#40
	db #00,#02,#40,#5b,#10,#40,#5b,#13
	db #40,#00,#02,#40,#5b,#10,#40,#5b
	db #13,#40,#00,#02,#40,#5b,#10,#40
	db #5b,#13,#40,#00,#02,#40,#5b,#10
	db #40,#5b,#13,#40,#00,#02,#40,#5b
	db #10,#40,#5b,#13,#40,#00,#02,#40
	db #5b,#10,#40,#5b,#13,#40,#00,#02
	db #40,#5b,#10,#40,#5b,#13,#40,#00
	db #02,#40,#5b,#10,#40,#5b,#13,#40
	db #00,#02,#40,#5b,#10,#40,#5b,#13
	db #40,#00,#02,#40,#5b,#10,#40,#5b
	...
	db #40,#5b,#13,#40,#00,#02,#40,#5b
	db #10,#40,#5b,#13,#40,#00,#02,#40
	db #5b,#20,#ff,#28,#d0,#10,#2b,#d0
	db #06,#2d,#d0,#03,#2b,#d0,#03,#28
	db #d0,#14,#2b,#d0,#06,#2d,#d0,#03
	db #2b,#d0,#03,#28,#d0,#04,#ff,#fe
	db #40,#ff,#11,#3b,#3b,#10,#3b,#8b
...
;
.music_info
	db "Acid Music Box 3 ADSPart (1995)(Acid)(ADS)",0
	db "ST-128 Module",0
