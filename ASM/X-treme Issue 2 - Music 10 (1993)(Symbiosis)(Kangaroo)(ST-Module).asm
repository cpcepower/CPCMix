; Music of X-treme Issue 2 - Music 10 (1993)(Symbiosis)(Kangaroo)(ST-Module)
...
.l4442 equ $ + 4
	...
	db #02,#47,#00,#00,#e4,#7a,#2b,#45
	db #dc,#2b,#b0,#18,#62,#46,#22,#47
	db #42,#45,#18,#07,#42,#47,#82,#47
	db #42,#45,#18,#07,#e5,#14,#b8,#7d
	db #94,#bc,#b8,#7d,#94,#bc,#b8,#7d
	db #94,#bc,#b8,#7d,#b9,#7d,#de,#3e
	db #bb,#7d,#62,#47,#5e,#86,#7e,#86
	db #bf,#7d,#e4,#3e,#c1,#7d,#c2,#7d
	db #c3,#7d,#e8,#3e,#c6,#7d,#c7,#7d
	db #c8,#7d,#ed,#3e,#ca,#7d,#cb,#7d
.l44c2 equ $ + 4
	db #dc,#3e,#40,#00,#5c,#3f,#9c,#3f
	db #dc,#3f,#1c,#40,#5c,#40,#9c,#40
	db #a2,#47,#1c,#41,#5c,#41,#9c,#41
	db #dc,#41,#1c,#42,#5c,#42,#9c,#42
	db #dc,#42,#1c,#43,#ff,#ff,#fe,#ff
	...
	db #00,#0c,#00,#0c,#00,#0c,#00,#0c
	db #00,#0c,#00,#0c,#00,#0c,#00,#0c
	db #00,#0c,#00,#0c,#00,#49,#48,#00
	db #72,#48,#00,#bf,#48,#00,#bf,#48
	db #00,#0c,#49,#00,#0c,#49,#00,#bf
	db #48,#00,#bf,#48,#00,#bf,#48,#00
	db #bf,#48,#00,#bf,#48,#00,#bf,#48
	db #00,#bf,#48,#00,#bf,#48,#80,#c5
	db #47,#00,#4b,#49,#00,#4b,#49,#00
	db #b3,#49,#00,#b3,#49,#00,#34,#4a
	db #00,#34,#4a,#00,#4f,#4a,#00,#69
	db #4a,#00,#83,#4a,#00,#83,#4a,#00
	db #4f,#4a,#00,#69,#4a,#00,#c2,#4a
	db #00,#c2,#4a,#80,#f2,#47,#00,#e0
	db #4a,#00,#e3,#4a,#00,#14,#4b,#00
	db #14,#4b,#00,#45,#4b,#00,#45,#4b
	db #00,#6c,#4b,#00,#7d,#4b,#00,#14
	db #4b,#00,#14,#4b,#00,#6c,#4b,#00
	db #7d,#4b,#00,#8e,#4b,#00,#8e,#4b
	db #80,#1f,#48,#00,#20,#2e,#04,#02
...
;
.music_info
	db "X-treme Issue 2 - Music 10 (1993)(Symbiosis)(Kangaroo)",0
	db "ST-Module",0
