; Music of Telepathique - Main Part 1 (1994)(Bugs)(Beta Soft Cologne)(ST-Module)
...
.l43fe equ $ + 4
	db #00,#00,#00,#00,#13,#4a,#00,#01
	db #08,#00,#01,#2d,#00,#00,#00,#df
.l440c equ $ + 2
	db #2f,#48,#06,#45,#46,#45,#66,#45
	db #00,#00,#01,#1f,#1c,#01,#00,#00
.l441a
	db #bc,#4d,#02,#03,#09,#02,#01,#41
.l4428 equ $ + 6
	db #00,#00,#00,#e7,#5c,#48,#06,#46
	db #46,#46,#66,#46,#00,#00,#01,#1f
.l4436 equ $ + 4
	db #59,#00,#a6,#00,#4a,#50,#04,#05
	db #0a,#05,#04,#4a,#00,#00,#00,#ef
.l4444 equ $ + 2
	db #89,#48,#06,#46,#06,#47,#66,#46
	db #14,#09,#01,#1f,#59,#00,#e6,#47
...
;
.music_info
	db "Telepathique - Main Part 1 (1994)(Bugs)(Beta Soft Cologne)",0
	db "ST-Module",0
