; Music of Rulez! Mag 1 - Music 7 (2014)(CPCRulez)(Aleksandr Ekshibarov)(ProTracker 3.5)
...
.l1d19 equ $ + 2
.l1d18 equ $ + 1
	db #e8,#00,#14,#00,#00,#00,#00,#00
.l1d25 equ $ + 6
.l1d24 equ $ + 5
	db #00,#00,#00,#00,#00,#00,#5d,#34
.l1d27
	db #49,#33,#02,#35,#00,#00,#01,#00
.l1d35 equ $ + 6
.l1d33 equ $ + 4
	db #00,#00,#00,#00,#02,#a0,#00,#01
	db #00,#00,#00,#00,#00,#00,#00,#00
.l1d44 equ $ + 5
.l1d42 equ $ + 3
.l1d41 equ $ + 2
	db #00,#00,#00,#5d,#34,#b7,#33,#02
	db #41,#00,#00,#01,#00,#00,#00,#00
.l1d52 equ $ + 3
.l1d50 equ $ + 1
	db #00,#02,#b0,#00,#14,#00,#00,#00
.l1d5e equ $ + 7
	db #00,#00,#00,#00,#00,#00,#00,#00
.l1d61 equ $ + 2
.l1d5f
	db #5d,#34,#49,#33,#02,#29,#00,#00
.l1d6d equ $ + 6
	db #01,#00,#00,#00,#00,#00,#02,#80
.l1d75 equ $ + 6
.l1d74 equ $ + 5
.l1d73 equ $ + 4
.l1d72 equ $ + 3
...
.l2010 equ $ + 1
	...
	db #b0,#c9,#0f,#00,#16,#08,#46,#00
	db #16,#00,#c6,#02,#c6,#14,#00,#40
	db #80,#00,#16,#00,#c6,#02,#00,#00
...
.l2121 equ $ + 2
	...
	db #1b,#c1,#03,#00,#00,#01,#02,#02
	db #02,#04,#00,#03,#04,#02,#01,#00
	db #01,#05,#00,#00,#00,#01,#00,#01
	db #01,#03,#03,#02,#04,#04,#05,#02
	db #05,#04,#03,#08,#00,#01,#00,#02
	db #00,#02,#01,#02,#04,#03,#03,#04
	db #05,#00,#04,#05,#01,#01,#02,#03
	db #01,#02,#04,#08,#0c,#10,#20,#21
	db #29,#39,#3d,#3f,#40,#42,#62,#63
	db #01,#02,#04,#05,#07,#09,#11,#19
.l2466 equ $ + 7
.l2461 equ $ + 2
	db #1d,#2d,#3d,#5d,#61,#81,#91,#99
	db #01,#02,#04,#05,#09,#0a,#0e,#10
	db #14,#24,#2c,#34,#44,#64,#65,#75
	db #01,#03,#05,#09,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
...
.l2564 equ $ + 1
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#01,#05,#13,#03,#dd
.l257c equ $ + 1
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#f9,#04,#a3,#05,#a9,#05,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#27,#06,#59,#06,#97
	db #06,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
.l25bc equ $ + 1
	db #00,#dd,#06,#e0,#06,#00,#00,#00
	db #00,#00,#00,#f2,#06,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
.l25dc equ $ + 1
	db #00,#00,#03,#0c,#06,#09,#0f,#12
	db #15,#18,#15,#18,#06,#09,#0f,#12
	db #1b,#1e,#21,#24,#ff,#2b,#01,#3f
.l25fa equ $ + 7
	db #01,#84,#01,#98,#01,#b4,#01,#f7
	db #01,#41,#02,#49,#02,#8e,#02,#a1
	db #02,#bb,#02,#00,#03,#0c,#02,#b4
	db #01,#27,#02,#41,#02,#49,#02,#26
	db #03,#39,#03,#48,#03,#8a,#03,#a7
	db #03,#49,#02,#c1,#03,#d7,#03,#bb
	db #02,#f1,#03,#07,#04,#49,#02,#4d
	db #04,#65,#04,#bb,#02,#ab,#04,#07
	db #04,#49,#02,#c5,#04,#65,#04,#bb
	db #02,#df,#04,#b1,#30,#c0,#f0,#08
	db #cd,#01,#b1,#02,#71,#01,#06,#00
	db #ce,#d0,#cf,#b1,#0c,#d0,#00,#f0
	db #1a,#cf,#b1,#02,#6a,#d6,#5e,#de
	db #6a,#d6,#5e,#dd,#6a,#d6,#5e,#de
	db #6a,#d6,#5e,#dd,#6d,#d6,#61,#de
.l266e equ $ + 3
	db #6d,#d6,#61,#dd,#6d,#d6,#61,#de
	db #6d,#d6,#61,#dd,#6f,#d6,#63,#de
	db #6f,#d6,#63,#dd,#6f,#d6,#63,#de
	db #6f,#d6,#63,#dd,#6a,#d6,#5e,#de
	db #6a,#d6,#5e,#dd,#6a,#d6,#5e,#de
	db #6a,#d6,#5e,#00,#b1,#30,#c0,#f0
	db #08,#cd,#01,#b1,#02,#6a,#01,#06
	db #00,#ce,#d0,#cf,#b1,#0c,#d0,#00
	db #f0,#0a,#cf,#b1,#10,#6a,#6d,#6f
.l26b5 equ $ + 2
	db #b1,#08,#6a,#d4,#01,#b1,#04,#82
	db #01,#18,#00,#b1,#02,#c0,#01,#82
	db #01,#18,#00,#00,#f0,#1a,#cf,#b1
	db #02,#6a,#d6,#5e,#de,#6a,#d6,#5e
	db #dd,#6a,#d6,#5e,#de,#6a,#d6,#5e
	db #dd,#6d,#d6,#61,#de,#6d,#d6,#61
	db #dd,#6d,#d6,#61,#de,#6d,#d6,#61
	db #dd,#6f,#d6,#63,#de,#6f,#d6,#63
	db #dd,#6f,#d6,#63,#de,#6f,#d6,#63
.l26fe equ $ + 3
	db #dd,#6a,#d6,#5e,#de,#6a,#d6,#5e
	db #dd,#6a,#de,#76,#76,#76,#00,#f0
	db #0a,#cf,#b1,#10,#71,#74,#76,#b1
	db #0c,#71,#d4,#01,#b1,#02,#82,#01
	db #18,#00,#c0,#00,#f0,#0a,#cf,#b1
	db #10,#6a,#6d,#6f,#b1,#08,#6a,#d4
	db #01,#b1,#02,#82,#01,#18,#00,#c0
	db #01,#82,#01,#18,#00,#c0,#00,#f0
	db #0a,#cf,#b1,#10,#71,#74,#76,#b1
	db #0a,#71,#d4,#01,#b1,#02,#82,#01
	db #18,#00,#c0,#01,#82,#01,#18,#00
	db #00,#f0,#0a,#cf,#b1,#20,#6a,#6d
	db #00,#f0,#1a,#cf,#b1,#02,#6a,#d6
	db #5e,#de,#6a,#d6,#5e,#dd,#6a,#d6
	db #5e,#de,#6a,#d6,#5e,#dd,#6a,#d6
	db #5e,#de,#6a,#d6,#5e,#dd,#6a,#d6
	db #5e,#de,#6a,#d6,#5e,#dd,#6d,#d6
	db #61,#de,#6d,#d6,#61,#dd,#6d,#d6
	db #61,#de,#6d,#d6,#61,#dd,#6d,#d6
	db #61,#de,#6d,#d6,#61,#dd,#6d,#d6
	db #61,#de,#6d,#d6,#61,#00,#f0,#08
	db #cf,#b1,#14,#76,#b1,#04,#79,#78
	db #76,#b1,#08,#74,#71,#b1,#10,#74
	db #00,#f0,#0a,#cf,#b1,#20,#6f,#b1
	db #18,#6a,#d4,#01,#b1,#04,#82,#01
	db #18,#00,#b1,#02,#c0,#01,#82,#01
	db #18,#00,#00,#f0,#1a,#cf,#b1,#02
	db #6f,#d6,#63,#de,#6f,#d6,#63,#dd
	db #6f,#d6,#63,#de,#6f,#d6,#63,#dd
	db #6f,#d6,#63,#de,#6f,#d6,#63,#dd
	db #6f,#d6,#63,#de,#6f,#d6,#63,#dd
	db #6a,#d6,#5e,#de,#6a,#d6,#5e,#dd
	db #6a,#d6,#5e,#de,#6a,#d6,#5e,#dd
	db #6a,#d6,#5e,#de,#6a,#d6,#5e,#dd
	db #6a,#d6,#5e,#de,#6a,#d6,#5e,#00
	db #f0,#08,#cf,#b1,#14,#72,#b1,#04
	db #76,#74,#72,#b1,#0a,#76,#ce,#b1
	db #02,#d0,#cd,#d0,#cc,#d0,#cb,#d0
	db #ca,#b1,#0a,#d0,#cf,#01,#b1,#02
	db #82,#01,#18,#00,#c0,#00,#f0,#08
	db #cf,#b1,#14,#76,#b1,#04,#76,#78
	db #79,#b1,#08,#7d,#79,#b1,#10,#7d
	db #00,#f0,#0a,#cf,#b1,#20,#6f,#b1
	db #10,#6a,#01,#d0,#01,#fa,#ff,#00
	db #f0,#1a,#cf,#b1,#02,#6f,#d6,#63
	db #de,#6f,#d6,#63,#dd,#6f,#d6,#63
	db #de,#6f,#d6,#63,#dd,#6f,#d6,#63
	db #de,#6f,#d6,#63,#dd,#6f,#d6,#63
	db #de,#6f,#d6,#63,#dd,#6a,#d6,#5e
	db #de,#6a,#d6,#5e,#dd,#6a,#d6,#5e
	db #de,#6a,#d6,#5e,#dd,#6a,#d6,#5e
	db #de,#6a,#d6,#5e,#dd,#5e,#76,#76
	db #76,#00,#f0,#08,#cf,#b1,#14,#7b
	db #b1,#04,#7b,#7d,#7f,#b1,#08,#82
	db #ce,#b1,#02,#d0,#cd,#d0,#cc,#d0
	db #cb,#d0,#ca,#b1,#10,#c0,#00,#f0
	db #1e,#cd,#b1,#14,#6a,#d4,#ce,#b1
	db #04,#6d,#6c,#6a,#df,#cd,#b1,#14
	db #6d,#d4,#ce,#b1,#04,#6d,#71,#74
	db #00,#f0,#08,#cf,#b1,#04,#76,#76
	db #76,#79,#b1,#10,#7d,#b1,#04,#7d
	db #7d,#7d,#7b,#b1,#10,#79,#00,#f0
	db #1e,#cd,#b1,#14,#6f,#d4,#ce,#b1
	db #04,#6f,#73,#76,#df,#cd,#b1,#14
	db #6a,#d4,#ce,#b1,#04,#6d,#6c,#6a
	db #00,#f0,#08,#cf,#b1,#04,#7b,#7b
	db #7b,#79,#b1,#10,#76,#b1,#04,#76
	db #76,#79,#78,#b1,#10,#76,#00,#f0
	db #0c,#cd,#b1,#01,#89,#c0,#76,#c0
	db #82,#c0,#79,#c0,#85,#c0,#7d,#c0
	db #89,#c0,#79,#c0,#85,#c0,#76,#c0
	db #82,#c0,#79,#c0,#85,#c0,#7d,#c0
	db #89,#c0,#79,#c0,#85,#c0,#79,#c0
	db #85,#c0,#7d,#c0,#89,#c0,#80,#c0
	db #8c,#c0,#7d,#c0,#89,#c0,#79,#c0
	db #85,#c0,#7d,#c0,#89,#c0,#80,#c0
	db #8c,#c0,#7d,#c0,#00,#f5,#08,#cf
	db #b1,#04,#76,#76,#76,#79,#b1,#08
	db #7d,#79,#b1,#04,#7d,#7d,#7d,#7b
	db #b1,#08,#79,#7d,#00,#f0,#0c,#cd
	db #b1,#01,#85,#c0,#7b,#c0,#87,#c0
	db #7f,#c0,#8b,#c0,#82,#c0,#8e,#c0
	db #7f,#c0,#8b,#c0,#7b,#c0,#87,#c0
	db #7f,#c0,#8b,#c0,#82,#c0,#8e,#c0
	db #7f,#c0,#8b,#c0,#76,#c0,#82,#c0
	db #79,#c0,#85,#c0,#7d,#c0,#89,#c0
	db #79,#c0,#85,#c0,#76,#c0,#82,#c0
	db #79,#c0,#85,#c0,#7d,#c0,#89,#c0
	db #79,#c0,#00,#f5,#08,#cf,#b1,#04
	db #7b,#7b,#7b,#79,#b1,#08,#76,#74
	db #b1,#04,#76,#76,#79,#78,#76,#40
	db #ce,#6d,#6c,#6a,#00,#f1,#08,#cf
	db #b1,#04,#76,#76,#76,#79,#7d,#79
	db #b1,#08,#76,#b1,#04,#7d,#7d,#7d
	db #7b,#79,#7b,#b1,#08,#7d,#00,#f1
	db #08,#cf,#b1,#04,#7b,#7b,#7b,#79
	db #b1,#08,#76,#74,#b1,#04,#76,#76
	db #79,#78,#76,#40,#ce,#6d,#6c,#6a
	db #00,#23,#2a,#00,#8e,#00,#00,#00
	db #8e,#00,#00,#00,#8e,#00,#00,#00
	db #8e,#00,#00,#00,#8e,#00,#00,#00
	db #8e,#00,#00,#00,#8e,#00,#00,#00
	db #8e,#00,#00,#00,#8e,#01,#00,#00
	db #8e,#01,#00,#00,#8e,#01,#00,#00
	db #8d,#01,#00,#00,#8d,#ff,#ff,#00
	db #8d,#ff,#ff,#00,#8d,#ff,#ff,#00
	db #8d,#ff,#ff,#00,#8d,#03,#00,#00
	db #8d,#03,#00,#00,#8d,#03,#00,#00
	db #8d,#03,#00,#00,#8c,#fd,#ff,#00
	db #8c,#fd,#ff,#00,#8c,#fd,#ff,#00
	db #8c,#fd,#ff,#00,#8c,#fd,#ff,#00
	db #8c,#03,#00,#00,#8c,#03,#00,#00
	db #8c,#03,#00,#00,#8c,#03,#00,#00
	db #8c,#03,#00,#00,#8c,#fd,#ff,#00
	db #8c,#fd,#ff,#00,#8b,#fd,#ff,#00
	db #8b,#fd,#ff,#00,#8b,#fd,#ff,#00
	db #8b,#03,#00,#00,#8b,#03,#00,#00
	db #8b,#03,#00,#00,#8b,#03,#00,#00
	db #8b,#fd,#ff,#00,#8b,#fd,#ff,#00
	db #8b,#fd,#ff,#00,#01,#00,#8c,#00
	db #00,#09,#1f,#00,#8f,#00,#00,#00
	...
	db #8a,#00,#00,#00,#8a,#00,#00,#00
	db #8a,#00,#00,#00,#8a,#00,#00,#00
	db #8a,#fe,#ff,#00,#8a,#fc,#ff,#00
	db #8a,#fe,#ff,#00,#8a,#00,#00,#00
	db #8a,#02,#00,#00,#8a,#04,#00,#00
	db #8a,#02,#00,#00,#8a,#00,#00,#00
	db #8a,#fe,#ff,#00,#8a,#fc,#ff,#00
	db #8a,#fe,#ff,#00,#8a,#00,#00,#00
	db #8a,#02,#00,#00,#8a,#04,#00,#0b
	db #0c,#3e,#0f,#01,#03,#00,#8f,#00
	db #04,#00,#8d,#00,#05,#00,#8a,#80
	db #05,#00,#88,#00,#06,#00,#85,#80
	db #06,#00,#83,#00,#07,#00,#80,#80
	db #07,#00,#80,#02,#08,#00,#80,#80
.l2b6a equ $ + 7
.l2b69 equ $ + 6
	db #08,#00,#80,#00,#09,#00,#00,#00
	db #00,#0e,#0f,#06,#0f,#40,#00,#0a
	db #0e,#80,#00,#06,#0d,#c0,#00,#04
	db #0b,#00,#01,#04,#0a,#40,#01,#04
	db #09,#80,#01,#04,#08,#c0,#01,#06
	db #07,#00,#02,#06,#06,#40,#02,#06
	db #05,#80,#02,#08,#04,#c0,#02,#08
	db #03,#00,#03,#0a,#02,#40,#03,#0c
	db #01,#80,#03,#0e,#00,#00,#00,#00
	db #11,#00,#8e,#00,#00,#00,#8e,#00
	...
	db #00,#00,#8e,#00,#00,#00,#8e,#00
	db #00,#00,#8e,#00,#00,#00,#8e,#00
	db #00,#00,#8e,#00,#00,#00,#01,#00
	db #0f,#10,#18,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#3f,#40,#0c,#13,#0c,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	...
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#01,#74,#74,#d2
	db #cf,#b1,#02,#a4,#a4,#8c,#8c,#74
	db #74,#d4,#cd,#74,#b1,#01,#74,#74
	db #00,#f0,#0e,#ce,#b1,#02,#80,#cd
	db #d0,#cc,#d0,#cb,#d0,#ca,#d0,#c9
	db #d0,#ce,#82,#80,#7f,#cd,#d0,#cc
	db #d0,#cb,#d0,#ce,#7b,#cd,#d0,#cc
	db #d0,#cb,#d0,#ce,#7d,#cd,#d0,#cc
	db #d0,#cb,#d0,#ca,#d0,#c9,#d0,#c8
	db #d0,#c7,#d0,#c6,#d0,#c5,#d0,#c4
	db #d0,#c3,#d0,#c2,#d0,#c1,#d0,#dd
	db #4c,#ce,#b1,#04,#80,#00,#1a,#00
	db #2d,#12,#40,#cf,#b1,#01,#79,#c0
	db #bb,#00,#16,#85,#c0,#bb,#00,#3c
	db #74,#c0,#bb,#00,#16,#85,#c0,#bb
	db #00,#2d,#79,#c0,#bb,#00,#16,#85
	db #c0,#bb,#00,#3c,#74,#c0,#bb,#00
	db #16,#85,#c0,#bb,#00,#2f,#78,#c0
	db #bb,#00,#18,#84,#c0,#bb,#00,#3f
	db #73,#c0,#bb,#00,#18,#84,#c0,#bb
	db #00,#2f,#78,#c0,#bb,#00,#18,#84
	db #c0,#bb,#00,#3f,#73,#c0,#bb,#00
	db #18,#84,#c0,#bb,#00,#23,#7d,#c0
	db #bb,#00,#12,#89,#c0,#bb,#00,#2f
	db #78,#c0,#bb,#00,#12,#89,#c0,#bb
	db #00,#23,#7d,#c0,#bb,#00,#12,#89
	db #c0,#bb,#00,#2f,#78,#c0,#bb,#00
	db #12,#89,#c0,#bb,#00,#23,#7d,#d2
	db #b0,#a4,#d9,#bb,#00,#12,#89,#d2
	db #b0,#a4,#d9,#bb,#00,#2f,#78,#d2
	db #b0,#8c,#d9,#bb,#00,#12,#89,#d2
	db #b0,#8c,#d9,#bb,#00,#23,#7d,#d2
	db #b0,#74,#d9,#bb,#00,#12,#89,#d2
	db #b0,#74,#d9,#bb,#00,#2f,#78,#c0
	db #bb,#00,#12,#89,#c0,#00,#f0,#08
	db #cd,#b1,#02,#74,#b1,#01,#74,#74
	db #b1,#02,#74,#b1,#01,#74,#74,#b1
	db #02,#74,#b1,#01,#74,#74,#b1,#02
	db #74,#b1,#01,#74,#74,#b1,#02,#74
	db #b1,#01,#74,#74,#b1,#02,#74,#b1
	db #01,#74,#74,#b1,#02,#74,#b1,#01
	db #74,#74,#b1,#02,#74,#b1,#01,#74
	db #74,#b1,#02,#74,#b1,#01,#74,#74
	db #b1,#02,#74,#b1,#01,#74,#74,#b1
	db #02,#74,#b1,#01,#74,#74,#b1,#02
	db #74,#b1,#01,#74,#74,#b1,#02,#74
	db #b1,#01,#74,#74,#b1,#02,#74,#b1
	db #01,#74,#74,#d2,#ce,#b1,#02,#74
	db #d3,#cd,#b1,#01,#74,#74,#d2,#ce
	db #b1,#02,#74,#d3,#cd,#74,#00,#fc
	db #1a,#ce,#b1,#04,#7d,#cc,#b1,#02
	db #80,#b1,#06,#7d,#40,#ce,#b1,#04
	db #80,#7f,#b1,#02,#7d,#b1,#06,#7b
	db #b1,#04,#79,#b1,#02,#78,#cd,#d0
	db #cc,#d0,#cb,#d0,#ca,#d0,#c9,#d0
	db #ce,#b1,#04,#82,#82,#b1,#02,#80
	db #b1,#06,#7f,#4c,#b1,#04,#80,#00
	db #1a,#00,#2d,#12,#40,#cf,#b1,#02
	db #79,#bb,#00,#16,#85,#bb,#00,#3c
	db #74,#bb,#00,#16,#85,#bb,#00,#2d
	db #79,#bb,#00,#16,#85,#bb,#00,#3c
	db #74,#bb,#00,#16,#85,#bb,#00,#28
	db #7b,#bb,#00,#14,#87,#bb,#00,#35
	db #76,#bb,#00,#14,#87,#bb,#00,#28
	db #7b,#bb,#00,#14,#87,#bb,#00,#35
	db #76,#bb,#00,#14,#87,#bb,#00,#2f
	db #78,#bb,#00,#18,#84,#bb,#00,#3f
	db #73,#bb,#00,#18,#84,#bb,#00,#2f
	db #78,#bb,#00,#18,#84,#bb,#00,#3f
	db #73,#bb,#00,#18,#84,#bb,#00,#23
	db #7d,#bb,#00,#12,#89,#bb,#00,#2f
	db #78,#bb,#00,#12,#89,#bb,#00,#23
	db #7d,#bb,#00,#12,#89,#bb,#00,#2f
	db #78,#bb,#00,#12,#89,#00,#f0,#08
	db #cd,#b1,#02,#74,#b1,#01,#74,#74
	db #b1,#02,#74,#b1,#01,#74,#74,#b1
	db #02,#74,#b1,#01,#74,#74,#b1,#02
	db #74,#b1,#01,#74,#74,#b1,#02,#74
	...
	db #74,#b1,#01,#74,#74,#b1,#02,#74
	db #b1,#01,#74,#74,#b1,#02,#74,#b1
	db #01,#74,#74,#d2,#ce,#b1,#02,#a4
	db #a4,#8c,#8c,#00,#fc,#1a,#ce,#b1
	db #04,#7d,#cc,#b1,#02,#80,#b1,#06
	db #7d,#40,#ce,#b1,#04,#80,#7f,#b1
	db #02,#7d,#b1,#06,#7b,#b1,#04,#79
	db #b1,#02,#78,#cd,#d0,#cc,#d0,#cb
	db #d0,#ca,#d0,#c9,#d0,#ce,#b1,#04
	db #76,#b1,#02,#78,#cd,#d0,#cc,#d0
	db #cb,#d0,#ca,#d0,#c9,#d0,#4c,#ce
	db #b1,#04,#80,#00,#fc,#1a,#ce,#b1
	db #04,#7d,#cc,#b1,#02,#80,#7d,#cb
	db #d0,#ca,#d0,#c9,#d0,#c8,#b1,#0e
	db #d0,#ce,#b1,#04,#80,#b1,#02,#7d
	db #cd,#d0,#cc,#d0,#cb,#d0,#ca,#d0
	db #c9,#d0,#c8,#d0,#c7,#d0,#c6,#d0
	db #c5,#d0,#c4,#d0,#c3,#d0,#c2,#d0
	db #c1,#b1,#04,#d0,#b1,#02,#c0,#00
	db #1a,#00,#2d,#12,#40,#cf,#b1,#02
	db #79,#bb,#00,#16,#85,#bb,#00,#3c
	db #74,#bb,#00,#16,#85,#bb,#00,#2d
	db #79,#bb,#00,#16,#85,#bb,#00,#3c
	db #74,#bb,#00,#16,#85,#bb,#00,#2f
	db #78,#bb,#00,#18,#84,#bb,#00,#3f
	db #73,#bb,#00,#18,#84,#bb,#00,#2f
	db #78,#bb,#00,#18,#84,#bb,#00,#3f
	db #73,#bb,#00,#18,#84,#bb,#00,#23
	...
	db #7d,#bb,#00,#12,#89,#bb,#00,#2f
	db #78,#bb,#00,#12,#89,#bb,#00,#23
	db #b1,#01,#7d,#d2,#b0,#a4,#d9,#bb
	db #00,#12,#89,#d2,#b0,#a4,#d9,#bb
	db #00,#2f,#78,#d2,#b0,#8c,#d9,#bb
	db #00,#12,#89,#d2,#b0,#8c,#00,#f0
	db #04,#cf,#b1,#04,#74,#d4,#74,#d2
	db #b1,#02,#74,#74,#d4,#b1,#04,#74
	db #d2,#74,#d4,#74,#d2,#b1,#02,#74
	db #74,#d4,#b1,#04,#74,#d2,#74,#d4
	db #74,#d2,#b1,#02,#74,#74,#d4,#74
	db #74,#d2,#b1,#04,#74,#d4,#74,#d2
	db #b1,#02,#74,#74,#d4,#b1,#04,#74
	db #00,#f0,#04,#cf,#b1,#04,#74,#d4
	db #74,#d2,#b1,#02,#74,#74,#d4,#b1
	db #04,#74,#d2,#74,#d4,#74,#d2,#b1
	db #02,#74,#74,#d4,#b1,#04,#74,#d2
	db #74,#d4,#74,#d2,#b1,#02,#74,#74
	db #d4,#74,#74,#d2,#b1,#04,#74,#d4
	db #74,#d2,#b1,#02,#a4,#a4,#8c,#8c
	db #00,#f0,#0e,#cc,#b1,#01,#95,#c0
	db #95,#c0,#97,#c0,#95,#c0,#95,#97
	db #98,#9a,#9c,#c0,#98,#c0,#b1,#04
	db #9d,#cb,#b1,#02,#d0,#ca,#d0,#c9
	db #d0,#c8,#d0,#c7,#d0,#c6,#d0,#cc
	db #b1,#01,#9f,#9d,#9c,#9a,#98,#97
	db #95,#93,#91,#90,#8e,#8c,#8b,#89
	db #87,#85,#b1,#04,#84,#cb,#b1,#02
	db #d0,#ca,#d0,#c9,#d0,#c8,#d0,#dd
	db #4c,#ce,#b1,#04,#80,#00,#f0,#0c
	db #c8,#b1,#02,#89,#c9,#d0,#ca,#d0
	db #cb,#d0,#ca,#d0,#c9,#d0,#c8,#d0
	db #c7,#d0,#c8,#85,#c9,#d0,#ca,#d0
	db #cb,#d0,#ca,#d0,#c9,#d0,#c8,#d0
	db #c7,#d0,#c8,#87,#c9,#d0,#ca,#d0
	db #cb,#d0,#ca,#d0,#c9,#d0,#c8,#d0
	db #c7,#d0,#c8,#84,#c9,#d0,#ca,#d0
	db #cb,#d0,#ca,#b1,#01,#d0,#d2,#cf
	db #b1,#02,#a4,#a4,#8c,#b1,#01,#8c
	db #00,#f0,#04,#cf,#b1,#02,#74,#d4
	db #cc,#b1,#01,#74,#74,#b1,#02,#74
	db #b1,#01,#74,#74,#b1,#02,#74,#b1
	db #01,#74,#74,#b1,#02,#74,#b1,#01
	db #74,#74,#b1,#02,#74,#b1,#01,#74
	db #74,#b1,#02,#74,#b1,#01,#74,#74
	...
	db #74,#74,#b1,#02,#74,#b1,#01,#74
	db #74,#b1,#02,#74,#b1,#01,#74,#74
	db #d2,#cf,#b1,#04,#a4,#ca,#a4,#00
	db #fc,#1a,#ce,#b1,#04,#7d,#cc,#b1
	db #02,#80,#7d,#cb,#d0,#ca,#d0,#c9
	db #d0,#c8,#b1,#0e,#d0,#ce,#b1,#04
	db #80,#b1,#02,#7d,#cd,#d0,#cc,#d0
	db #cb,#d0,#ca,#d0,#c9,#d0,#c8,#d0
	db #c7,#d0,#c6,#d0,#c5,#d0,#c4,#d0
	db #c3,#d0,#c2,#b1,#08,#c0,#00,#1a
	db #00,#2d,#12,#40,#cf,#b1,#02,#79
	db #bb,#00,#16,#85,#bb,#00,#3c,#74
	db #bb,#00,#16,#85,#bb,#00,#2d,#79
	db #bb,#00,#16,#85,#bb,#00,#3c,#74
	db #bb,#00,#16,#85,#bb,#00,#2f,#78
	db #bb,#00,#18,#84,#bb,#00,#3f,#73
	db #bb,#00,#18,#84,#bb,#00,#2f,#78
	db #bb,#00,#18,#84,#bb,#00,#3f,#73
	db #bb,#00,#18,#84,#bb,#00,#23,#7d
	db #bb,#00,#12,#89,#bb,#00,#2f,#78
	db #bb,#00,#12,#89,#bb,#00,#23,#7d
	db #bb,#00,#12,#89,#bb,#00,#2f,#78
	db #bb,#00,#12,#89,#bb,#00,#23,#7d
	db #bb,#00,#12,#89,#bb,#00,#2f,#78
	db #bb,#00,#12,#89,#d3,#b0,#b1,#04
	db #7d,#ca,#7d,#00,#f0,#04,#c9,#b1
	db #04,#a4,#c8,#a4,#b1,#18,#c0,#00
	db #b1,#20,#c0,#00,#f0,#06,#c9,#b1
	db #04,#74,#c8,#74,#b1,#18,#c0,#00
	...
	db #00,#00,#00,#8e,#00,#00,#06,#07
	db #00,#90,#00,#00,#00,#90,#00,#00
	db #00,#90,#00,#00,#00,#90,#00,#00
	db #00,#90,#00,#00,#00,#90,#00,#00
	db #00,#90,#00,#00,#0f,#1f,#00,#8d
	...
	db #00,#00,#00,#8d,#00,#00,#00,#8d
	db #00,#00,#00,#8c,#01,#f0,#00,#8c
	db #01,#f0,#00,#8c,#01,#f0,#00,#8c
	db #02,#f0,#00,#8c,#02,#f0,#00,#8c
	db #02,#f0,#00,#8c,#01,#f0,#00,#8c
	db #01,#f0,#00,#8c,#01,#f0,#00,#8c
	db #00,#00,#00,#8c,#00,#00,#00,#8c
	db #00,#00,#00,#8c,#ff,#ff,#00,#8c
	db #ff,#ff,#00,#8c,#ff,#ff,#00,#8c
	db #00,#00,#00,#01,#00,#05,#06,#fc
	db #fc,#fd,#fe,#ff,#00,#05,#06,#07
...
;
.music_info
	db "Rulez! Mag 1 - Music 7 (2014)(CPCRulez)(Aleksandr Ekshibarov)",0
	db "ProTracker 3.5",0
