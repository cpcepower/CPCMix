; Music of DarkAge Part 3 (1995)(Power System)(Epsilon)(ST-128 Module)
...
;
.music_info
	db "DarkAge Part 3 (1995)(Power System)(Epsilon)",0
	db "ST-128 Module",0
