; Music of F-16 Fighting Falcon (1989)(Mastertronic)(Jason C. Brooke)()
; Ripped by Megachur the 02/07/2008
; $VER 1.5
...
.l96b3
	...
	dw l96ee,#0000
.l96c7
	dw l9756,l9711,l9795,#0000
.l96cf
	dw l9753,l9753,l9795,#0000
.l96d7
...
.l97dd equ $ + 2
	...
	db #eb,#d2,#2a
.l97ee
	db #8a,#88,#01,#01,#d1,#e3,#2b,#e0
	db #26,#26,#e1,#2b,#26,#2f,#eb,#d2
	db #2d,#00
;
.music_info
	db "F-16 Fighting Falcon (1989)(Mastertronic)(Jason C. Brooke)",0
	db "",0
