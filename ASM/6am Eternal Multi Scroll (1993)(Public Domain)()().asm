; Music of 6am Eternal Multi Scroll (1993)(Public Domain)()()
...
.l1804 equ $ + 3
.l1801
	db #00,#b5,#1e,#75,#1c,#02,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #01,#01,#00,#09,#00,#03,#03,#05
.l1820 equ $ + 7
	db #03,#0f,#01,#01,#01,#00,#09,#00
.l1824 equ $ + 3
.l1823 equ $ + 2
	db #fe,#24,#b5,#1c,#02,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#01
	db #20,#00,#00,#00,#f1,#00,#01,#00
.l183f equ $ + 6
	db #0f,#00,#00,#00,#00,#12,#00,#fe
.l1843 equ $ + 2
.l1842 equ $ + 1
	db #24,#f5,#1c,#02,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#01,#20
	db #00,#00,#00,#f1,#00,#01,#00,#0f
	db #00,#00,#00,#00,#24
	ld c,a		; sound fx ?
	add a
	add c
...
.l1b7f equ $ + 2
.l1b7d
	dw #077c,#077c,#077c,#3101
.l1b8b equ $ + 6
.l1b8a equ $ + 5
.l1b87 equ $ + 2
.l1b86 equ $ + 1
.l1b85
	dw #0009,#0000,#0000,#077c
	dw #0708,#06b0,#0640,#05ec
	dw #0594,#0544,#04f8,#04b0
...
;
.music_info
	db "6am Eternal Multi Scroll (1993)(Public Domain)()",0
	db "Same as Glider Rider (1986)(Quicksilva)(David Whittaker)",0
