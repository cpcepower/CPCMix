; Music of Bordelik Meeting 4 Slide Show - Main Part 1 (1995)(Arkos)(Targhan)(ST-128 Module)
...
.l4640
	...
	db #d2,#ff,#32,#4a,#72,#4a,#40,#47
	db #ea,#07,#76,#ff,#c4,#49,#12,#4a
	db #a4,#ff,#76,#ff,#76,#ff,#a4,#ff
	db #a4,#ff,#76,#ff,#34,#01,#b2,#01
	db #02,#02,#24,#02,#74,#02,#f2,#02
	db #d2,#ff,#92,#4a,#b2,#4a,#d2,#ff
...
;
.music_info
	db "Bordelik Meeting 4 Slide Show - Main Part 1 (1995)(Arkos)(Targhan)",0
	db "ST-128 Module",0
