; Music of Street Gang Football (1989)(Codemasters)(David Whittaker)()
...
.l9699 equ $ + 5
	db #f7,#ff,#00,#02,#08,#a3,#96,#ac
	db #96,#be,#96,#d2,#96,#b8,#96,#0e
...
.l978c equ $ + 2
	dw #0000,l97c3,l97c3,l97ed
.l9796 equ $ + 4
	dw l97ed,#0000,l97d8,l97d8
	dw l97ee,l97ee,#0000
.l97a0
...
.l97c3 equ $ + 3
	db #e1,#19,#87,#88,#01,#01,#8a,#d3
	db #e1,#22,#e7,#22,#e1,#22,#22,#20
	db #1e,#e7,#1e,#e1,#1e,#1e,#20,#87
.l97d8
...
.l97ed equ $ + 5
	...
	db #27,#25,#27,#e3,#1e,#20,#87,#00
;
.music_info
	db "Street Gang Football (1989)(Codemasters)(David Whittaker)",0
	db "",0
