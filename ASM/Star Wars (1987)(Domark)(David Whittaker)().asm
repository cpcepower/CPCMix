...
; Ripped by Megachur the 18/07/2019
; $VER 1.5
...
.l7e3b
	db #ff,#80,#1b,#34,#04
.l7e46 equ $ + 6
	dw l7e46,l7e50,l7e4a,l7e56
.l7e4a equ $ + 2
	dw #0000,l7efa,l7f24,#0000
.l7e50
	dw l7f0e,l7f24,#0000
.l7e56
...
.l7efa equ $ + 4
	db #8f,#eb,#80,#87,#8a,#dd,#00,#21
	db #05,#c0,#88,#01,#02,#82,#e1,#1a
	db #1a,#1a,#81,#dd,#00,#31,#02,#87
.l7f0e
	db #8a,#dd,#00,#21,#05,#c0,#88,#01
	db #02,#82,#e1,#26,#26,#26,#88,#01
.l7f24 equ $ + 6
	db #01,#dd,#00,#31,#02,#87,#eb,#2b
	...
	db #eb,#2d,#e5,#32,#f7,#37,#f1,#8f
	db #df,#00,#11,#05,#e1,#37,#37,#37
	db #e2,#37,#8f,#e5,#8f,#eb,#80,#87
	db #00,#00
;
; org #b5eb
; call #76f6	; play music
;
; org #b359
; xor a
; call #763c	; init music
;
.music_info
