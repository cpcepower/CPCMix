; Music of Ghoul's Writer Muzaxx Collector Long Time (19xx)(Scorpion)()(ST Module)
...
.l6442 equ $ + 4
	...
	db #42,#65,#00,#00,#49,#92,#45,#f3
	db #fc,#60,#00,#ff,#ff,#3e,#21,#d1
	db #70,#9d,#23,#56,#23,#40,#10,#3f
	db #09,#bd,#23,#4e,#fe,#3e,#ca,#3f
	db #98,#3d,#50,#30,#62,#65,#a2,#65
	db #c2,#65,#0b,#15,#ec,#3d,#a0,#6f
	db #08,#15,#4d,#4f,#62,#65,#e2,#65
	db #c2,#65,#00,#00,#02,#66,#42,#66
	db #c2,#65,#08,#18,#00,#7e,#00,#7e
	...
	db #00,#7e,#00,#00,#00,#7e,#00,#7e
.l64c2 equ $ + 4
	db #00,#7e,#00,#00,#46,#85,#62,#66
	db #82,#66,#a2,#66,#00,#7e,#00,#7e
	...
	db #07,#00,#04,#07,#00,#04,#07,#00
.l66c2 equ $ + 4
	db #04,#07,#00,#04,#00,#13,#67,#00
	db #16,#67,#00,#16,#67,#00,#36,#67
	db #00,#36,#67,#00,#52,#67,#00,#52
.l66dd equ $ + 7
	db #67,#00,#78,#67,#80,#c2,#66,#00
	db #a9,#67,#00,#a9,#67,#00,#a9,#67
	db #00,#a9,#67,#00,#a9,#67,#00,#a9
	db #67,#00,#a9,#67,#00,#a9,#67,#80
.l66f8 equ $ + 2
	db #dd,#66,#00,#f3,#67,#00,#02,#68
	db #00,#02,#68,#00,#11,#68,#00,#11
	db #68,#00,#20,#68,#00,#20,#68,#00
	db #2f,#68,#80,#f8,#66,#00,#40,#ff
...
;
.music_info
	db "Ghoul's Writer Muzaxx Collector Long Time (19xx)(Scorpion)()",0
	db "ST Module",0
