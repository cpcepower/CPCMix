; Music of Electric Fanzine 2 - Menu (19xx)(Public Domain)()(Music Pro)
...
.l9207 equ $ + 1
	...
	db #01,#00,#01,#00,#01,#01,#01,#ff
;
;;;; 280 MEMORY &88FF:LOAD "music"
;;;; 290 LOAD"musicmen.bin",&9200:CALL &8900
; 300 RETURN
;
.music_info
	db "Electric Fanzine 2 - Menu (19xx)(Public Domain)()",0
	db "Music Pro",0
