; Music of Generation CPC Issue 2 - Pub (1990)(Public Domain)(LBC)(Music Pro)
...
.l8e52 equ $ + 1
.l8e51
	db #ff,#ff,#10,#92,#4e,#92,#0f,#92
.l8e59
	db #1b,#20,#02,#02,#00,#00,#00,#00
	db #0f,#00,#00,#00,#00,#00,#00,#05
	db #00,#00,#ff,#00,#01,#00,#00,#00
	db #05,#00,#02,#00,#00,#00,#00,#00
	db #ff,#04,#04,#00,#ff,#ff,#01,#02
	db #07,#01,#ff,#04,#04,#08,#ff,#fc
.l8e8d equ $ + 4
	db #00,#fe,#00,#02,#ff,#1c,#92,#9a
.l8e94 equ $ + 3
.l8e92 equ $ + 1
	db #92,#1b,#92,#1b,#40,#00,#04,#00
	...
	db #00,#00,#00,#00,#00,#00,#00,#00
.l8ec8 equ $ + 7
	db #00,#00,#d6,#00,#d6,#00,#00,#ff
.l8ecf equ $ + 6
.l8ecd equ $ + 4
	db #2c,#92,#d8,#92,#2b,#92,#03,#04
	db #00,#04,#00,#00,#00,#00,#0f,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
.l8ee7 equ $ + 6
	db #f1,#00,#00,#08,#53,#00,#00,#00
.l8eef equ $ + 6
	db #00,#00,#01,#00,#00,#00,#00,#01
	db #00,#00,#c4,#00,#03,#00,#00,#14
	db #00,#01,#00,#00,#11,#00,#00,#00
	db #00,#00,#00,#01,#00,#00,#0f,#00
	db #06,#00,#00,#00,#00,#0f,#00,#00
	db #ff,#00,#01,#00,#00,#00,#00,#0f
	db #00,#00,#00,#00,#0f,#00,#00,#00
	db #00,#0f,#00,#00,#00,#00,#0f,#00
.l8f2b equ $ + 2
	db #00,#00,#00,#01,#00,#00,#0f,#00
	db #02,#00,#00,#00,#00,#01,#00,#00
	db #f1,#00,#01,#08,#53,#00,#00,#08
	db #00,#00,#00,#ff,#04,#04,#08,#ff
	db #ff,#02,#02,#08,#01,#ff,#04,#04
	db #08,#ff,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#01
	db #00,#00,#00,#00,#01,#00,#00,#c4
	db #00,#03,#00,#00,#14,#00,#01,#00
.l8f80 equ $ + 7
.l8f7e equ $ + 5
.l8f7c equ $ + 3
.l8f7b equ $ + 2
	db #00,#11,#01,#2d,#92,#e3,#92,#e3
.l8f88 equ $ + 7
.l8f87 equ $ + 6
.l8f86 equ $ + 5
.l8f85 equ $ + 4
...
.l9201 equ $ + 1
.l9200
	db #03,#08,#03,#2c,#00,#e2,#00,#e2
.l920d equ $ + 5
.l920b equ $ + 3
.l9209 equ $ + 1
	db #01,#0e,#00,#1a,#00,#2a,#00,#00
	db #01,#00,#00,#01,#00,#01,#01,#01
	db #01,#00,#ff,#04,#04,#04,#04,#04
	db #02,#02,#03,#02,#02,#04,#04,#05
	db #05,#06,#ff,#07,#ff,#3e,#00,#57
	db #00,#63,#00,#7b,#00,#93,#00,#9a
	db #00,#a6,#00,#ce,#00,#5a,#95,#e0
	db #00,#a0,#d1,#e2,#05,#84,#2d,#2f
	db #30,#82,#2f,#30,#88,#2d,#84,#2d
	db #2f,#30,#82,#2f,#30,#88,#2d,#ff
	db #e0,#00,#a0,#d1,#e2,#05,#86,#2f
	db #32,#30,#2f,#ff,#e0,#00,#a0,#d1
	db #e2,#01,#82,#2d,#2d,#2d,#2d,#c0
	db #86,#2d,#d1,#82,#2d,#2d,#2d,#2d
	db #c0,#86,#2d,#ff,#e0,#00,#a0,#d1
	db #e2,#01,#82,#2f,#2f,#2f,#2f,#32
	db #32,#32,#32,#30,#30,#30,#30,#2f
	db #2f,#2f,#2f,#ff,#e0,#00,#a0,#c0
	db #8a,#30,#ff,#e0,#00,#a0,#d6,#e1
	db #03,#86,#2f,#32,#30,#2f,#ff,#e0
	db #00,#a0,#c1,#e1,#0e,#82,#2d,#2d
	db #2d,#2d,#2d,#2d,#2d,#2d,#2d,#2d
	db #2d,#2d,#2f,#2f,#2f,#2f,#2d,#2d
	db #2d,#2d,#2d,#2d,#2d,#2d,#2d,#2d
	db #2d,#2d,#2f,#2f,#2f,#2f,#ff,#e0
	db #00,#a2,#d0,#e2,#00,#82,#00,#00
	db #a5,#cd,#e1,#02,#2c,#a2,#d0,#e2
	db #00,#00,#ff,#0f,#00,#0f,#00,#0f
	...
	db #00,#01,#00,#0f,#01,#97,#97,#83
	db #aa,#01,#00,#01,#0d,#01,#00,#03
	db #00,#01,#00,#07,#02,#04,#00,#87
	db #b1,#8b,#cd,#01,#0e,#01,#00,#82
	...
	db #00,#01,#01,#10,#00,#01,#05,#01
	db #05,#01,#05,#08,#00,#01,#01,#01
...
;
.music_info
	db "Generation CPC Issue 2 - Pub (1990)(Public Domain)(LBC)",0
	db "Music Pro",0
