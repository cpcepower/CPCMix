; Music of Rulez! Mag 1 - Music 6 (2014)(CPCRulez)(Aleksandr Ekshibarov)(ProTracker 3.5)
...
.l1d27
	db #df,#1c,#40,#00,#00,#00,#00,#00
.l1d35 equ $ + 6
.l1d33 equ $ + 4
	db #00,#00,#00,#00,#31,#f0,#00,#07
	db #00,#00,#00,#00,#00,#00,#00,#00
.l1d44 equ $ + 5
.l1d42 equ $ + 3
.l1d41 equ $ + 2
	db #00,#00,#00,#69,#30,#3b,#30,#02
	db #2d,#00,#00,#01,#00,#00,#00,#00
.l1d52 equ $ + 3
.l1d50 equ $ + 1
	db #00,#01,#f0,#01,#13,#00,#00,#00
.l1d5e equ $ + 7
	db #00,#00,#00,#00,#00,#00,#00,#00
.l1d61 equ $ + 2
.l1d5f
	db #6c,#30,#b5,#2e,#02,#2d,#00,#00
.l1d6d equ $ + 6
	db #01,#00,#00,#00,#00,#00,#01,#70
.l1d75 equ $ + 6
.l1d74 equ $ + 5
.l1d73 equ $ + 4
.l1d72 equ $ + 3
...
.l2010 equ $ + 1
	...
	db #b0,#c9,#0f,#00,#1b,#08,#46,#00
	db #1b,#00,#c3,#02,#c3,#14,#00,#40
	db #80,#00,#1b,#00,#c3,#02,#00,#00
...
.l2121 equ $ + 2
	...
	db #1b,#c1,#03,#00,#01,#01,#03,#03
	db #04,#05,#05,#02,#04,#00,#00,#00
	db #00,#00,#00,#00,#00,#01,#00,#01
	db #00,#02,#02,#00,#03,#04,#07,#07
	db #07,#08,#06,#0b,#00,#01,#00,#01
	db #00,#00,#00,#00,#03,#04,#02,#04
	db #03,#05,#08,#07,#00,#00,#01,#00
	db #01,#03,#05,#0d,#15,#25,#45,#65
	db #69,#79,#7a,#7b,#7c,#7d,#7e,#7f
	db #01,#02,#04,#05,#07,#08,#0c,#10
.l2466 equ $ + 7
.l2461 equ $ + 2
	db #11,#19,#29,#a9,#29,#a9,#a9,#e9
	db #01,#02,#04,#05,#07,#08,#09,#0a
	db #0b,#13,#23,#27,#37,#3f,#5f,#5f
...
.l2564 equ $ + 1
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#01,#06,#1d,#00,#e7
.l257c equ $ + 1
	db #00,#00,#00,#00,#00,#48,#0d,#6e
	db #0d,#b0,#0d,#00,#00,#36,#0e,#a4
	db #0e,#00,#00,#ae,#0e,#00,#00,#00
	db #00,#00,#00,#cc,#0e,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
.l25bc equ $ + 1
	db #00,#4a,#0f,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
	db #00,#4d,#0f,#00,#00,#00,#00,#00
.l25de equ $ + 3
.l25dc equ $ + 1
	db #00,#00,#1e,#03,#1b,#06,#09,#0c
	db #0f,#12,#15,#12,#18,#03,#1b,#06
	db #09,#0c,#0f,#12,#15,#12,#18,#21
	db #24,#12,#15,#12,#27,#2a,#ff,#41
	db #01,#86,#01,#d1,#01,#61,#02,#86
.l2603
	db #01,#9b,#02,#b8,#03,#26,#04,#4f
	db #04,#d5,#04,#26,#04,#4f,#04,#57
	db #05,#df,#05,#24,#06,#ca,#06,#49
	db #07,#8e,#07,#46,#08,#bf,#08,#f8
	db #08,#7e,#09,#ec,#09,#f8,#08,#b8
	db #03,#2c,#0a,#68,#0a,#61,#02,#16
	db #02,#21,#03,#41,#01,#16,#02,#d1
	db #01,#ff,#0a,#86,#01,#41,#01,#39
	db #0b,#71,#0b,#be,#0b,#09,#0c,#78
	db #0c,#af,#0c,#2c,#0d,#38,#0d,#3c
	db #0d,#f0,#0c,#c8,#b1,#02,#89,#c9
.l2660 equ $ + 5
	db #d0,#ca,#d0,#cb,#d0,#ca,#d0,#c9
	db #d0,#c8,#d0,#c7,#d0,#c8,#85,#c9
	db #d0,#ca,#d0,#cb,#d0,#ca,#d0,#c9
	db #d0,#c8,#d0,#c7,#d0,#c8,#87,#c9
.l2682 equ $ + 7
	db #d0,#ca,#d0,#cb,#d0,#ca,#d0,#c9
	db #d0,#c8,#d0,#c7,#d0,#c8,#84,#c9
	db #d0,#ca,#d0,#cb,#d0,#ca,#d0,#c9
	db #d0,#c8,#d0,#c7,#d0,#00,#f0,#0e
	db #cc,#b1,#01,#95,#c0,#95,#c0,#97
	db #c0,#95,#c0,#9c,#9a,#98,#c0,#97
	db #c0,#95,#c0,#b1,#04,#91,#cb,#b1
	db #02,#d0,#ca,#d0,#c9,#d0,#c8,#d0
	db #c7,#d0,#c6,#d0,#cc,#b1,#01,#93
	db #c0,#93,#c0,#95,#c0,#93,#c0,#93
	db #95,#97,#98,#9a,#9c,#9d,#9a,#b1
	db #04,#9c,#cb,#b1,#02,#d0,#ca,#d0
	db #c9,#d0,#c8,#d0,#c7,#d0,#c6,#d0
	db #00,#f0,#0c,#c6,#b1,#02,#7d,#c7
.l26ee equ $ + 3
	db #d0,#c8,#d0,#c9,#d0,#ca,#d0,#cb
	db #d0,#ca,#d0,#c9,#d0,#c8,#79,#c7
	db #d0,#c8,#d0,#c9,#d0,#ca,#d0,#cb
	db #d0,#ca,#d0,#c9,#d0,#c8,#7b,#c7
	db #d0,#c8,#d0,#c9,#d0,#ca,#d0,#cb
	db #d0,#ca,#d0,#c9,#d0,#c8,#78,#c7
	db #d0,#c8,#d0,#c9,#d0,#ca,#d0,#cb
	db #d0,#ca,#d0,#c9,#d0,#00,#f0,#0e
	db #cc,#b1,#01,#95,#c0,#95,#c0,#97
	db #c0,#95,#c0,#95,#97,#98,#9a,#9c
	db #c0,#98,#c0,#b1,#04,#9d,#cb,#b1
	db #02,#d0,#ca,#d0,#c9,#d0,#c8,#d0
	db #c7,#d0,#c6,#d0,#cc,#b1,#01,#9f
	db #9d,#9c,#9a,#98,#97,#95,#93,#91
	db #90,#8e,#8c,#8b,#89,#87,#85,#b1
	db #04,#84,#cb,#b1,#02,#d0,#ca,#d0
	db #c9,#d0,#c8,#d0,#c7,#d0,#c6,#d0
	db #00,#f0,#04,#cf,#b1,#04,#74,#d4
	db #74,#d2,#b1,#02,#74,#74,#d4,#74
	db #74,#d2,#b1,#04,#74,#d4,#74,#d2
	db #b1,#02,#74,#74,#d4,#74,#74,#d2
	db #b1,#04,#74,#d4,#74,#d2,#b1,#02
	db #74,#74,#d4,#74,#74,#d2,#b1,#04
	db #74,#d4,#74,#d2,#b1,#02,#a4,#a4
	db #8c,#8c,#00,#1a,#00,#23,#12,#40
	db #cf,#b1,#02,#7d,#bb,#00,#12,#89
	db #bb,#00,#2f,#78,#bb,#00,#12,#89
	db #bb,#00,#23,#7d,#bb,#00,#12,#89
	db #bb,#00,#2f,#78,#bb,#00,#12,#89
	db #bb,#00,#2d,#79,#bb,#00,#16,#85
	db #bb,#00,#3c,#74,#bb,#00,#16,#85
	db #bb,#00,#2d,#79,#bb,#00,#16,#85
	db #bb,#00,#3c,#74,#bb,#00,#16,#85
	db #bb,#00,#28,#7b,#bb,#00,#14,#87
	db #bb,#00,#35,#76,#bb,#00,#14,#87
	db #bb,#00,#28,#7b,#bb,#00,#14,#87
	db #bb,#00,#35,#76,#bb,#00,#14,#87
	db #bb,#00,#2f,#78,#bb,#00,#18,#84
	db #bb,#00,#3f,#73,#bb,#00,#18,#84
	db #bb,#00,#2f,#78,#bb,#00,#18,#84
	db #bb,#00,#3f,#73,#bb,#00,#2f,#78
	db #00,#1a,#00,#23,#12,#40,#cf,#b1
	db #02,#7d,#bb,#00,#12,#89,#bb,#00
	db #2f,#78,#bb,#00,#12,#89,#bb,#00
	db #23,#7d,#bb,#00,#12,#89,#bb,#00
	db #2f,#78,#bb,#00,#12,#89,#bb,#00
	db #2d,#79,#bb,#00,#16,#85,#bb,#00
	db #3c,#74,#bb,#00,#16,#85,#bb,#00
	db #2d,#79,#bb,#00,#16,#85,#bb,#00
	db #3c,#74,#bb,#00,#16,#85,#bb,#00
	db #28,#7b,#bb,#00,#14,#87,#bb,#00
	db #35,#76,#bb,#00,#14,#87,#bb,#00
	db #28,#7b,#bb,#00,#14,#87,#bb,#00
	db #35,#76,#bb,#00,#14,#87,#bb,#00
	db #2f,#78,#bb,#00,#18,#84,#bb,#00
	db #3f,#73,#bb,#00,#18,#84,#bb,#00
	db #2f,#b1,#01,#78,#d2,#b0,#a4,#d9
	db #bb,#00,#18,#84,#d2,#b0,#a4,#d9
	db #bb,#00,#3f,#73,#d2,#b0,#8c,#d9
	db #bb,#00,#2f,#78,#d2,#b0,#8c,#00
	db #f0,#08,#cd,#b1,#02,#74,#b1,#01
	...
	db #b1,#02,#74,#b1,#01,#74,#74,#b1
	db #02,#74,#b1,#01,#74,#74,#b1,#02
	db #74,#b1,#01,#74,#74,#d2,#cf,#b1
	db #02,#a4,#a4,#8c,#8c,#00,#f0,#0c
	db #ce,#b1,#08,#84,#b1,#04,#7d,#84
	db #82,#b1,#02,#80,#b1,#04,#82,#b1
	db #06,#84,#d7,#b1,#04,#82,#b1,#02
	db #80,#b1,#06,#7f,#b1,#04,#82,#80
	db #b1,#02,#7f,#b1,#0a,#7d,#00,#1a
	db #00,#23,#12,#40,#cf,#b1,#02,#7d
	db #bb,#00,#12,#89,#bb,#00,#2f,#78
	db #bb,#00,#12,#89,#bb,#00,#23,#7d
	db #bb,#00,#12,#89,#bb,#00,#2f,#78
	db #bb,#00,#12,#89,#bb,#00,#35,#76
	db #bb,#00,#1b,#82,#bb,#00,#4f,#6f
	db #bb,#00,#1b,#82,#bb,#00,#35,#76
	db #bb,#00,#1b,#82,#bb,#00,#4f,#6f
	db #bb,#00,#1b,#82,#bb,#00,#2f,#78
	...
	db #bb,#00,#12,#89,#bb,#00,#23,#7d
	db #bb,#00,#12,#89,#bb,#00,#2f,#78
	db #bb,#00,#12,#89,#00,#f0,#04,#cf
	db #b1,#02,#74,#d4,#cd,#b1,#01,#74
	db #74,#b1,#02,#74,#b1,#01,#74,#74
	db #d3,#b1,#02,#74,#d4,#b1,#01,#74
	db #74,#b1,#02,#74,#b1,#01,#74,#74
	db #d2,#cf,#b1,#02,#74,#d4,#cd,#b1
	db #01,#74,#74,#b1,#02,#74,#b1,#01
	db #74,#74,#d3,#b1,#02,#74,#b1,#01
	db #74,#d4,#74,#b1,#02,#74,#b1,#01
	db #74,#74,#d2,#cf,#b1,#02,#74,#d4
	db #cd,#b1,#01,#74,#74,#b1,#02,#74
	db #b1,#01,#74,#74,#d3,#b1,#02,#74
	db #d4,#b1,#01,#74,#74,#b1,#02,#74
	db #b1,#01,#74,#74,#d2,#cf,#b1,#02
	db #74,#d4,#cd,#b1,#01,#74,#74,#b1
	db #02,#74,#b1,#01,#74,#74,#d2,#cf
	db #b1,#02,#a4,#a4,#8c,#8c,#00,#f0
	db #04,#cf,#b1,#02,#74,#d4,#cd,#b1
	db #01,#74,#74,#b1,#02,#74,#b1,#01
	db #74,#74,#d3,#cf,#b1,#02,#74,#d4
	db #cd,#b1,#01,#74,#74,#b1,#02,#74
	db #b1,#01,#74,#74,#d2,#cf,#b1,#02
	db #74,#d4,#cd,#b1,#01,#74,#74,#b1
	db #02,#74,#b1,#01,#74,#74,#d3,#cf
	db #b1,#02,#74,#b1,#01,#74,#d4,#cd
	db #74,#b1,#02,#74,#b1,#01,#74,#74
	db #d2,#cf,#b1,#02,#74,#d4,#cd,#b1
	db #01,#74,#74,#b1,#02,#74,#b1,#01
	db #74,#74,#d3,#cf,#b1,#02,#74,#d4
	...
	db #02,#74,#b1,#01,#74,#74,#d2,#cf
	db #b1,#02,#a4,#a4,#8c,#8c,#00,#f0
	db #0e,#ce,#b1,#02,#80,#cd,#d0,#cc
	db #d0,#cb,#d0,#ce,#7d,#cd,#d0,#ce
	db #80,#cd,#d0,#ce,#7f,#cd,#d0,#cc
	db #d0,#cb,#d0,#ca,#d0,#c9,#d0,#c8
	db #d0,#c7,#d0,#ce,#84,#cd,#d0,#cc
	db #d0,#cb,#d0,#ce,#7f,#cd,#d0,#ce
	db #84,#cd,#d0,#ce,#80,#cd,#d0,#cc
	db #d0,#cb,#d0,#ca,#d0,#c9,#d0,#c8
	db #d0,#c7,#d0,#00,#1a,#00,#2d,#12
	db #40,#cf,#b1,#01,#79,#c0,#bb,#00
	db #16,#85,#c0,#bb,#00,#3c,#74,#c0
	db #bb,#00,#16,#85,#c0,#bb,#00,#2d
	db #79,#c0,#bb,#00,#16,#85,#c0,#bb
	db #00,#3c,#74,#c0,#bb,#00,#16,#85
.l2b6a equ $ + 7
.l2b69 equ $ + 6
	db #c0,#bb,#00,#28,#7b,#c0,#bb,#00
	db #14,#87,#c0,#bb,#00,#35,#76,#c0
	db #bb,#00,#14,#87,#c0,#bb,#00,#28
	db #7b,#c0,#bb,#00,#14,#87,#c0,#bb
	db #00,#35,#76,#c0,#bb,#00,#14,#87
	db #c0,#bb,#00,#2f,#78,#c0,#bb,#00
	db #18,#84,#c0,#bb,#00,#3f,#73,#c0
	db #bb,#00,#18,#84,#c0,#bb,#00,#2f
	db #78,#c0,#bb,#00,#18,#84,#c0,#bb
	db #00,#3f,#73,#c0,#bb,#00,#18,#84
	db #c0,#bb,#00,#23,#7d,#c0,#bb,#00
	db #12,#89,#c0,#bb,#00,#2f,#78,#c0
	db #bb,#00,#12,#89,#c0,#bb,#00,#23
	db #7d,#c0,#bb,#00,#12,#89,#c0,#bb
	db #00,#2f,#78,#c0,#bb,#00,#12,#89
	db #c0,#00,#f0,#04,#cf,#b1,#02,#74
	db #d4,#cd,#b1,#01,#74,#74,#b1,#02
	db #74,#b1,#01,#74,#74,#d3,#cf,#b1
	db #02,#74,#d4,#cd,#b1,#01,#74,#74
	db #b1,#02,#74,#b1,#01,#74,#74,#d2
	db #cf,#b1,#02,#74,#d4,#cd,#b1,#01
	db #74,#74,#b1,#02,#74,#b1,#01,#74
	db #74,#d3,#cf,#b1,#02,#74,#b1,#01
	db #74,#d4,#cd,#74,#b1,#02,#74,#b1
	db #01,#74,#74,#d2,#cf,#b1,#02,#74
	db #d4,#cd,#b1,#01,#74,#74,#b1,#02
	db #74,#b1,#01,#74,#74,#d3,#cf,#b1
	db #02,#74,#d4,#cd,#b1,#01,#74,#74
	db #b1,#02,#74,#b1,#01,#74,#74,#d2
...
;
.music_info
	db "Rulez! Mag 1 - Music 6 (2014)(CPCRulez)(Aleksandr Ekshibarov)",0
	db "ProTracker 3.5",0
