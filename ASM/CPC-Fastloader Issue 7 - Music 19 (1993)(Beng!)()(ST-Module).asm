; Music of CPC-Fastloader Issue 7 - Music 19 (1993)(Beng!)()(ST-Module)
...
.l4442 equ $ + 4
	...
	db #51,#3d,#f0,#30,#e2,#46,#22,#47
	db #42,#47,#00,#00,#62,#47,#a2,#47
	db #c2,#47,#00,#00,#e2,#45,#e2,#47
...
.l4802 equ $ + 4
	db #01,#00,#00,#00,#00,#53,#48,#00
	db #75,#48,#00,#a9,#48,#00,#fe,#48
	db #00,#fe,#48,#00,#a9,#48,#00,#a9
.l481d equ $ + 7
	db #48,#00,#53,#49,#80,#0b,#48,#00
	db #9f,#49,#00,#9f,#49,#00,#9f,#49
	db #00,#9f,#49,#00,#9f,#49,#00,#9f
	db #49,#00,#df,#49,#00,#60,#4a,#80
.l4838 equ $ + 2
	db #26,#48,#00,#d4,#4a,#00,#d4,#4a
	db #00,#d4,#4a,#00,#16,#4b,#00,#16
	db #4b,#00,#96,#4b,#00,#17,#4c,#00
	db #98,#4c,#80,#41,#48,#52,#04,#04
	db #52,#84,#52,#84,#52,#84,#52,#84
	db #52,#84,#52,#84,#52,#84,#52,#84
	db #52,#84,#52,#84,#52,#84,#52,#84
	db #52,#84,#52,#84,#52,#84,#ff,#52
	db #04,#04,#52,#84,#52,#84,#52,#84
	db #52,#84,#52,#84,#52,#84,#52,#84
	db #52,#84,#52,#84,#52,#84,#52,#84
	db #52,#84,#c8,#01,#c8,#01,#c8,#01
	db #c8,#01,#c5,#01,#c5,#01,#c5,#01
	db #c5,#01,#c1,#01,#c1,#01,#c1,#01
	db #c1,#01,#ff,#3a,#04,#01,#3a,#03
	db #06,#ba,#01,#52,#02,#04,#3a,#02
	db #01,#3a,#02,#06,#3a,#82,#3a,#04
	db #01,#3a,#03,#06,#ba,#01,#d2,#04
	db #ba,#01,#3a,#82,#3a,#02,#06,#ba
	db #06,#ba,#06,#3a,#04,#01,#3a,#03
	db #06,#ba,#01,#52,#02,#04,#3a,#02
	db #01,#3a,#02,#06,#3a,#82,#ba,#01
	db #3a,#82,#ba,#01,#3a,#02,#06,#ba
	db #01,#ba,#01,#d2,#04,#ba,#06,#3a
	db #02,#01,#3a,#02,#06,#3a,#82,#ff
	db #3a,#04,#01,#3a,#03,#06,#ba,#01
	db #52,#02,#04,#3a,#02,#01,#3a,#02
	db #06,#3a,#82,#3a,#04,#01,#3a,#03
	db #06,#ba,#01,#d2,#04,#ba,#01,#3a
	db #82,#3a,#02,#06,#ba,#06,#ba,#06
	db #3a,#04,#01,#3a,#03,#06,#ba,#01
	db #52,#02,#04,#3a,#02,#01,#3a,#02
	db #06,#3a,#82,#ba,#01,#3a,#82,#ba
	db #01,#3a,#02,#06,#ba,#01,#ba,#01
	db #d2,#04,#ba,#06,#3a,#02,#01,#3a
	db #02,#06,#3a,#82,#ff,#3a,#04,#01
	db #3a,#03,#06,#ba,#01,#52,#02,#04
	db #3a,#02,#01,#3a,#02,#06,#3a,#82
	db #3a,#04,#01,#3a,#03,#06,#ba,#01
	db #d2,#04,#ba,#01,#3a,#82,#3a,#02
	db #06,#ba,#06,#ba,#06,#3a,#04,#01
	db #3a,#03,#06,#ba,#01,#52,#02,#04
	db #3a,#02,#01,#3a,#02,#06,#3a,#82
	db #ba,#01,#3a,#82,#ba,#01,#3a,#02
	db #06,#ba,#01,#ba,#01,#3a,#08,#09
...
;
.music_info
	db "CPC-Fastloader Issue 7 - Music 19 (1993)(Beng!)()",0
	db "ST-Module",0
