; Music of Dracula Fanz Issue 5 - Freedelire Extended Part - 3 (1995)(Dracula Fanz Team)(Ast)(ST-128 Module)
...
.l733d equ $ + 1
	db #38,#00,#00
.l733f
	db #c2,#71,#d5,#71,#d4,#71,#f9,#71
	db #f6,#71,#09,#72,#1a,#72,#42,#72
	db #5c,#72,#42,#72,#76,#72,#7f,#72
	db #a1,#72,#a9,#72,#c8,#72
.l735d
...
.l749a equ $ + 3
	...
	db #00,#00,#00,#00,#00,#00,#00,#00
.l74a9 equ $ + 2
	db #00,#00,#af,#78,#e5,#78,#1b,#79
.l74af
	db #4f,#75,#8f,#75,#af,#75,#1a,#06
	db #cf,#75,#0f,#76,#2f,#76,#80,#00
	db #4f,#76,#8f,#76,#af,#76,#9a,#06
	db #cf,#76,#0f,#77,#af,#75,#48,#00
	db #41,#2e,#cc,#44,#0a,#45,#c8,#16
	db #2f,#77,#6f,#77,#8f,#77,#c0,#00
	db #41,#2e,#0e,#45,#0a,#45,#c9,#16
	db #41,#2e,#0a,#45,#0a,#45,#c9,#16
	db #4f,#76,#af,#77,#af,#75,#00,#00
	db #cf,#77,#0f,#78,#af,#75,#08,#18
	db #41,#2e,#f8,#4d,#58,#8e,#37,#60
	db #98,#8e,#ca,#44,#0a,#45,#c9,#16
	db #0a,#45,#0a,#85,#0a,#45,#c9,#16
	db #0a,#45,#0a,#85,#0a,#35,#c9,#16
	db #0a,#45,#41,#2e,#73,#2e,#64,#00
	db #d2,#2e,#ff,#2e,#2c,#2f,#22,#01
.l752f
	db #2f,#78,#4f,#78,#ea,#2f,#6f,#78
	db #8f,#78,#7b,#30,#ad,#30,#41,#2e
	...
	db #00,#0c,#18,#00,#0c,#18,#00,#0c
	db #00,#51,#79,#00,#51,#79,#00,#51
	db #79,#00,#cb,#79,#00,#cb,#79,#00
	db #cb,#79,#00,#cb,#79,#00,#cb,#79
	db #00,#c1,#7a,#00,#cb,#79,#00,#cb
	db #79,#00,#46,#7a,#00,#46,#7a,#00
	db #cb,#79,#00,#c1,#7a,#00,#cb,#79
	db #00,#c1,#7a,#80,#b8,#78,#00,#3c
	...
	db #4d,#7b,#00,#4d,#7b,#00,#4d,#7b
	db #00,#4d,#7b,#00,#4d,#7b,#00,#4d
	db #7b,#80,#ee,#78,#00,#a3,#7b,#00
	db #a6,#7b,#00,#a6,#7b,#00,#bc,#7d
	db #00,#bc,#7d,#00,#2e,#7c,#00,#2e
	db #7c,#00,#a0,#7d,#00,#ae,#7d,#00
	db #2e,#7c,#00,#2e,#7c,#00,#e7,#7c
	db #00,#e7,#7c,#00,#a0,#7d,#00,#ae
	db #7d,#00,#a0,#7d,#00,#ae,#7d,#80
	db #24,#79,#49,#3f,#10,#fe,#01,#c9
	...
	db #02,#c9,#30,#c9,#30,#fe,#01,#c9
	db #30,#fe,#01,#c9,#30,#c9,#30,#c9
	db #30,#47,#3f,#11,#fe,#01,#c7,#30
	db #fe,#01,#c7,#30,#c7,#30,#fe,#02
	db #c7,#30,#c7,#30,#fe,#01,#c7,#30
	db #fe,#01,#c7,#30,#c7,#30,#c7,#30
	db #c7,#30,#fe,#01,#c7,#30,#fe,#01
	db #c7,#30,#c7,#30,#fe,#02,#c7,#30
	db #c7,#30,#fe,#01,#c7,#30,#fe,#01
	db #c7,#30,#c7,#30,#c7,#30,#ff,#4b
	db #3f,#10,#fe,#01,#cb,#30,#fe,#01
	db #cb,#30,#cb,#30,#fe,#02,#cb,#30
	db #cb,#30,#fe,#01,#cb,#30,#fe,#01
	db #cb,#30,#cb,#30,#cb,#30,#cb,#30
	db #fe,#01,#cb,#30,#fe,#01,#cb,#30
	db #cb,#30,#fe,#02,#cb,#30,#cb,#30
	db #fe,#01,#cb,#30,#fe,#01,#cb,#30
	db #cb,#30,#cb,#30,#49,#3f,#11,#fe
	db #01,#c9,#30,#fe,#01,#c9,#30,#c9
	db #30,#fe,#02,#c9,#30,#c9,#30,#fe
	db #01,#c9,#30,#fe,#01,#c9,#30,#c9
	db #30,#c9,#30,#c9,#30,#fe,#01,#c9
	...
	db #02,#c9,#30,#c9,#30,#fe,#01,#c9
	db #30,#fe,#01,#c9,#30,#c9,#30,#c9
	db #30,#ff,#45,#3f,#11,#fe,#01,#c5
	db #30,#fe,#01,#c5,#30,#c5,#30,#fe
	db #02,#c5,#30,#c5,#30,#fe,#01,#c5
	db #30,#fe,#01,#c5,#30,#c5,#30,#c5
	db #30,#c5,#30,#fe,#01,#c5,#30,#fe
	db #01,#c5,#30,#c5,#30,#fe,#02,#c5
	db #30,#c5,#30,#fe,#01,#c5,#30,#fe
	db #01,#c5,#30,#c5,#30,#c5,#30,#47
	...
	db #fe,#01,#c7,#30,#fe,#01,#c7,#30
	db #c7,#30,#c7,#30,#ff,#0d,#06,#38
	db #28,#10,#03,#a8,#50,#a8,#10,#a8
	db #50,#a8,#50,#a8,#50,#ff,#a8,#10
	...
	db #20,#03,#a8,#10,#28,#20,#03,#a8
	db #50,#28,#20,#03,#a8,#10,#28,#20
	db #02,#a8,#50,#a8,#10,#a8,#50,#a8
	db #50,#a8,#50,#ff,#00,#40,#ff,#c9
	db #06,#40,#0b,#10,#0b,#11,#0b,#11
	db #0b,#12,#0b,#12,#0b,#13,#0b,#13
	db #0b,#14,#0b,#14,#0b,#15,#0b,#15
	db #4b,#0b,#10,#0b,#10,#0b,#11,#0b
	db #11,#4c,#0b,#10,#0b,#10,#0b,#11
	db #0b,#11,#0b,#12,#0b,#12,#0b,#13
	db #0b,#13,#0b,#14,#0b,#14,#0b,#15
	db #0b,#15,#50,#0b,#10,#0b,#10,#0b
	db #11,#0b,#11,#51,#0b,#10,#0b,#10
	db #0b,#11,#0b,#11,#0b,#12,#0b,#12
	db #0b,#13,#0b,#13,#0b,#14,#0b,#14
	db #0b,#15,#0b,#15,#50,#0b,#10,#0b
	db #10,#0b,#11,#0b,#11,#49,#0b,#10
	db #0b,#10,#0b,#11,#0b,#11,#0b,#12
	db #0b,#12,#0b,#13,#0b,#13,#0b,#14
	db #0b,#14,#0b,#15,#0b,#15,#0b,#16
	db #0b,#16,#fe,#01,#0b,#10,#ff,#c9
	db #86,#30,#47,#8b,#13,#44,#8b,#15
	...
	db #8b,#15,#47,#8b,#10,#45,#8b,#13
	db #42,#8b,#15,#0b,#10,#fe,#01,#ff
	db #cb,#86,#30,#49,#8b,#13,#46,#8b
	...
	db #8b,#15,#49,#8b,#10,#47,#8b,#13
	db #44,#8b,#15,#49,#8b,#10,#47,#8b
	db #13,#44,#8b,#15,#0b,#10,#fe,#01
	db #ff,#49,#86,#40,#10,#49,#80,#10
	db #47,#80,#10,#47,#80,#10,#ff,#45
	db #86,#40,#10,#45,#80,#10,#47,#80
	db #10,#47,#80,#10,#ff,#49,#91,#e0
	db #c7,#90,#c9,#90,#4b,#90,#0e,#c9
	db #90,#cb,#90,#4c,#90,#0e,#cb,#90
	db #c9,#90,#44,#90,#0c,#02,#12,#01
	db #02,#12,#01,#02,#12,#01,#02,#12
	db #01,#ff,#17

;
.music_info
	db "Dracula Fanz Issue 5 - Freedelire Extended Part - 3 (1995)(Dracula Fanz Team)(Ast)",0
	db "ST-128 Module",0
