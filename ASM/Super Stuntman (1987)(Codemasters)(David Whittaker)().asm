; Music of Super Stuntman (1987)(Codemasters)(David Whittaker)()
...
.la3f2
	...
	db #87
.la403
	db #8a,#88,#01,#02,#82,#d1,#e1,#0c
	db #18,#1d,#1d,#21,#e3,#24,#e5,#27
	db #e1,#1d,#1d,#21,#e3,#24,#e5,#26
	db #e1,#1d,#1d,#21,#e3,#24,#e5,#25
	db #e1,#1d,#1d,#20,#e3,#25,#e1,#24
	db #87
.la42c
	db #d2,#88,#01,#01,#e1,#24,#24,#24
	db #e3,#28,#e5,#29,#e1,#21,#21,#21
	db #e3,#28,#e5,#29,#e1,#24,#24,#24
	db #e3,#28,#e5,#29,#e1,#21,#21,#21
	db #e3,#29,#e5,#28,#87
.la451
	db #da,#e0,#81,#0e,#13,#17,#1a,#13
	db #17,#1a,#1f,#17,#1a,#1f,#23,#1a
	db #1f,#23,#26,#1f,#23,#26,#2b,#23
	db #26,#2b,#2f,#26,#2b,#2f,#32,#2b
	db #2f,#32,#37,#1a,#1f,#23,#26,#1f
	db #23,#26,#2b,#23,#26,#2b,#2f,#26
	db #2b,#2f,#32,#2b,#2f,#32,#37,#2f
	db #32,#37,#3b,#32,#37,#3b,#3e,#37
	db #3b,#3e,#43,#87
.la495
	db #8b,#d6,#e7,#8d,#3f,#d2,#e5,#8c
	db #4d,#d6,#e1,#8d,#3f,#e7,#8d,#3f
	db #d2,#e3,#8c,#4d,#41,#87
.la4ab
	db #ff,#8a,#88,#01,#01,#82,#d0,#05
	db #87
.la4b8 equ $ + 4
.la4b6 equ $ + 2
.la4b4
	dw la4ba,la4d0,la4f1
.la4ba
	db #8a,#88,#01,#01,#82,#d2,#e1,#13
	db #13,#13,#13,#13,#13,#13,#13,#15
	db #15,#15,#15,#e7,#26,#8e
.la4d0
	db #8a,#88,#01,#01,#82,#da,#e0,#0e
	db #13,#17,#1a,#13,#17,#1a,#1f,#17
	db #1a,#1f,#23,#1a,#1f,#23,#26,#1a
	db #1e,#21,#26,#1e,#21,#26,#2a,#e7
	db #2b
.la4f1
	db #8a,#88,#01,#01,#82,#d6,#e0,#1a
	db #1f,#23,#26,#1f,#23,#26,#2b,#23
	db #26,#2b,#2f,#26,#2b,#2f,#32,#26
	db #2a,#2d,#32,#2a,#2d,#32,#36,#e7
	db #37
.la516 equ $ + 4
.la514 equ $ + 2
.la512
	dw la518,la52e,la54f
.la518
	db #8a,#88,#01,#01,#82,#d2,#e1,#13
	db #13,#13,#13,#13,#13,#13,#13,#15
	db #15,#15,#15,#e7,#1a,#8e
.la52e
	db #8a,#88,#01,#01,#82,#da,#e0,#26
	db #23,#1f,#1a,#23,#1f,#1a,#17,#1f
	db #1a,#17,#13,#1a,#17,#13,#0e,#21
	db #1e,#0e,#16,#1e,#0e,#16,#12,#e7
	db #1f
.la54f
	db #8a,#88,#01,#01,#82,#d6,#e0,#32
	db #2f,#2b,#26,#2f,#2b,#26,#23,#2b
	db #26,#23,#1f,#26,#23,#1f,#1a,#2d
	db #2a,#1a,#22,#2a,#1a,#22,#1e,#e7
	db #2b
.la570
	db #89,#00,#87
.la573
...
;
.music_info
	db "Super Stuntman (1987)(Codemasters)(David Whittaker)",0
	db "",0
