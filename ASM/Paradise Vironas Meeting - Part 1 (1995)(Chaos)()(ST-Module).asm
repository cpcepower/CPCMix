; Music of Paradise Vironas Meeting - Part 1 (1995)(Chaos)()(ST-Module)
...
.l9dba equ $ + 4
	db #00,#00,#00,#00,#d7,#a1,#00,#01
	db #08,#07,#02,#21,#00,#00,#00,#df
.l9dc8 equ $ + 2
	db #45,#a1,#c2,#9f,#c2,#a0,#22,#9f
	db #18,#07,#1e,#01,#38,#02,#00,#00
.l9dd6
	db #4f,#a2,#02,#03,#09,#07,#04,#36
.l9de4 equ $ + 6
	db #00,#00,#00,#e7,#72,#a1,#c2,#9f
	db #c2,#a0,#22,#9f,#18,#07,#02,#1e
.l9df2 equ $ + 4
	db #a9,#00,#00,#00,#10,#a5,#04,#05
	db #0a,#07,#02,#3d,#00,#00,#00,#ef
.l9e00 equ $ + 2
	db #9f,#a1,#c2,#9f,#c2,#a0,#22,#9f
	db #18,#07,#20,#00,#71,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
...
.la19c equ $ + 6
	...
	db #82,#48,#84,#47,#86,#ff,#ca,#01
	db #66,#68,#3c,#01,#c8,#6a,#6c,#6b
	db #c1,#02,#07,#30,#dd,#04,#72,#3d
	db #3f,#71,#0c,#04,#f4,#2e,#72,#7a
	db #79,#06,#74,#09,#42,#44,#71,#3d
	db #53,#71,#02,#27,#fd,#0a,#46,#4d
	db #82,#06,#55,#71,#3b,#3d,#5e,#c9
	db #8e,#3c,#12,#47,#82,#09,#7e,#8b
	db #50,#71,#85,#2b,#70,#fd,#10,#89
	db #71,#68,#01,#15,#3d,#9a,#8e,#29
	db #fd,#16,#78,#83,#a6,#88,#91,#f2
	db #fd,#4f,#69,#01,#71,#07,#00,#02
	db #40,#04,#17,#b6,#01,#07,#fd,#07
	db #9b,#6f,#02,#8e,#c9,#a0,#bb,#8f
	db #f1,#86,#fd,#1a,#30,#72,#0b,#0a
	db #86,#ff,#45,#70,#40,#4e,#87,#04
	db #06,#fa,#6f,#09,#2d,#e7,#84,#48
	db #11,#8a,#2b,#84,#c1,#06,#ec,#6f
	db #0a,#49,#84,#31,#64,#72,#ae,#08
	db #6e,#e5,#84,#a7,#1a,#77,#72,#18
	db #cd,#07,#40,#04,#82,#47,#82,#48
	db #84,#f1,#45,#82,#c5,#f7,#f4,#84
	db #47,#88,#fa,#fd,#01,#08,#11,#b8
	db #72,#01,#cb,#5c,#ff,#f3,#00,#cd
	db #0f,#00,#3b,#3b,#e1,#01,#b8,#00
	db #a1,#09,#5e,#23,#56,#01,#11,#00
	db #80,#97,#23,#4e,#fe,#ff,#ca,#30
	db #09,#00,#fe,#50,#30,#08,#3c,#4f
	db #06,#00,#02,#ed,#b0,#18,#ec,#fe
	db #a0,#24,#d6,#40,#4d,#27,#00,#af
	db #18,#70,#fe,#f0,#90,#20,#d6,#9c
	db #33,#7e,#23,#18,#63,#0c,#fe,#fd
	db #20,#05,#28,#3f,#07,#fe,#01,#fe
	db #20,#0f,#23,#46,#23,#d5,#14,#08
	db #56,#23,#e3,#eb,#2a,#e1,#18,#b7
	db #09,#d6,#f0,#20,#0c,#3e,#c6,#51
	db #33,#81,#20,#04,#18,#06,#3d,#20
	db #07,#4d,#48,#23,#2a,#18,#9d,#66
	db #08,#af,#f5,#8b,#5e,#53,#18,#13
	db #66,#06,#69,#35,#58,#19,#66,#10
	db #3e,#71,#23,#c6,#54,#8d,#61,#01
	db #04,#f1,#64,#3e,#4e,#69,#02,#e5
	db #0b,#62,#6b,#13,#77,#56,#18,#7f
	db #c6,#00,#00,#00,#00,#10,#a9,#ff
	db #f0,#bf,#ff
;
.music_info
	db "Paradise Vironas Meeting - Part 1 (1995)(Chaos)()",0
	db "ST-Module",0
