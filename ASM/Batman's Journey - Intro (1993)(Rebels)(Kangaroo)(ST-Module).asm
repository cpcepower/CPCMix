; Music of Batman's Journey - Intro (1993)(Rebels)(Kangaroo)(ST-Module)
...
.l43da equ $ + 4
	db #00,#00,#00,#00,#5c,#48,#00,#01
	db #08,#07,#01,#3c,#00,#00,#03,#df
.l43e8 equ $ + 2
	db #c8,#46,#e2,#44,#22,#46,#42,#46
	db #00,#00,#0c,#14,#77,#00,#00,#00
.l43f6
	db #d3,#49,#02,#03,#09,#01,#01,#3b
.l4404 equ $ + 6
	db #00,#00,#02,#e7,#ec,#46,#e2,#44
	db #62,#45,#42,#45,#00,#00,#12,#0e
.l4412 equ $ + 4
	db #7f,#00,#00,#00,#f3,#4b,#04,#05
	db #0a,#00,#06,#13,#00,#10,#00,#ef
.l4420 equ $ + 2
	db #10,#47,#e2,#44,#22,#45,#42,#45
	db #00,#00,#12,#0e,#fc,#04,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#00
...
;
.music_info
	db "Batman's Journey - Intro (1993)(Rebels)(Kangaroo)",0
	db "ST-Module",0
