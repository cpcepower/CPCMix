; Music of Acid Music Box 3 Megas (1995)(Acid)(Eliot)(ST-128 Module)
...
.l46c0 equ $ + 6
	...
	db #07,#0c,#10,#00,#00,#03,#07,#0c
	db #10,#00,#00,#03,#07,#0c,#10,#00
	db #00,#03,#07,#0c,#10,#00,#00,#03
	db #07,#0c,#10,#00,#00,#03,#00,#0b
	db #4a,#00,#66,#4a,#00,#32,#4b,#00
	db #71,#4a,#00,#71,#4a,#00,#71,#4a
	db #00,#71,#4a,#00,#71,#4a,#00,#71
	db #4a,#00,#71,#4a,#00,#71,#4a,#00
	db #71,#4a,#00,#71,#4a,#00,#71,#4a
	db #00,#71,#4a,#00,#71,#4a,#00,#71
	db #4a,#00,#71,#4a,#80,#60,#49,#00
	db #ed,#4b,#00,#ed,#4b,#00,#32,#4c
	db #00,#f1,#4b,#00,#f1,#4b,#00,#3c
	db #4c,#00,#f1,#4b,#00,#5e,#4c,#00
	db #5e,#4c,#00,#f1,#4b,#00,#5e,#4c
	db #00,#f1,#4b,#00,#f1,#4b,#00,#3c
	db #4c,#00,#3c,#4c,#00,#f1,#4b,#00
	db #39,#4c,#00,#80,#4c,#80,#99,#49
	db #00,#8a,#4c,#00,#8a,#4c,#00,#8a
	db #4c,#00,#39,#4c,#00,#39,#4c,#00
	db #a7,#4c,#00,#8d,#4c,#00,#ac,#4c
	db #00,#ac,#4c,#00,#c0,#4c,#00,#ac
	db #4c,#00,#c0,#4c,#00,#c0,#4c,#00
	db #a7,#4c,#00,#22,#4d,#00,#39,#4c
	db #00,#39,#4c,#00,#8a,#4c,#80,#d2
	db #49,#cb,#36,#2d,#06,#2d,#01,#06
	db #2c,#01,#06,#2c,#01,#06,#2b,#01
	db #06,#2b,#01,#06,#2a,#01,#06,#2a
	db #01,#06,#29,#01,#06,#29,#01,#06
	db #28,#01,#06,#28,#01,#06,#27,#01
	db #06,#27,#01,#06,#26,#01,#06,#26
	db #01,#06,#25,#01,#06,#25,#01,#06
	db #24,#01,#06,#24,#01,#06,#23,#01
	db #06,#23,#01,#06,#22,#01,#06,#22
	db #01,#06,#21,#01,#06,#21,#01,#06
	db #20,#01,#06,#20,#05,#47,#30,#10
	db #49,#30,#10,#ff,#4b,#3f,#02,#20
	db #47,#30,#10,#49,#30,#10,#ff,#b3
	db #38,#20,#27,#ef,#11,#b8,#38,#18
	db #2c,#ef,#11,#b3,#38,#20,#27,#ef
	db #11,#b8,#38,#18,#2c,#ef,#11,#b3
	db #38,#20,#27,#ef,#11,#b8,#38,#18
	db #2c,#ef,#11,#c0,#38,#0f,#34,#ef
	db #11,#bf,#38,#10,#33,#ef,#11,#b3
	db #38,#20,#27,#ef,#11,#b8,#38,#18
	db #2c,#ef,#11,#b3,#38,#20,#27,#ef
	db #11,#b8,#38,#18,#2c,#ef,#11,#b3
	db #38,#20,#27,#ef,#11,#b8,#38,#18
	...
	db #38,#20,#27,#ef,#11,#b8,#38,#18
	db #2c,#ef,#11,#c0,#38,#0f,#34,#ef
	db #11,#bf,#38,#10,#33,#ef,#11,#ff
	db #cb,#36,#20,#06,#20,#01,#06,#20
	...
	db #01,#06,#20,#01,#06,#20,#01,#06
	db #20,#01,#06,#20,#01,#06,#20,#01
	db #06,#21,#01,#06,#21,#01,#06,#22
	db #01,#06,#22,#01,#06,#23,#01,#06
	db #23,#01,#06,#24,#01,#06,#24,#01
	db #06,#25,#01,#06,#25,#01,#06,#26
	db #01,#06,#26,#01,#06,#27,#01,#06
	db #27,#01,#06,#28,#01,#06,#28,#01
	db #06,#29,#01,#06,#29,#01,#06,#2a
	db #01,#06,#2a,#01,#06,#2b,#01,#06
	db #2b,#01,#06,#2c,#01,#06,#2c,#01
	db #06,#2d,#01,#06,#2d,#01,#06,#2d
	db #01,#06,#2d,#01,#06,#2d,#01,#06
	db #2d,#01,#06,#2d,#01,#06,#2d,#01
	db #06,#2d,#01,#06,#2d,#01,#06,#2d
	db #01,#06,#2d,#01,#40,#11,#20,#40
	db #10,#02,#ff,#0d,#06,#40,#ff,#40
	db #0d,#04,#04,#40,#10,#04,#40,#00
	db #04,#40,#00,#02,#40,#10,#02,#40
	db #0d,#04,#04,#40,#10,#04,#40,#00
	db #04,#40,#00,#02,#40,#10,#02,#40
	db #0d,#04,#04,#40,#10,#04,#40,#00
	db #04,#40,#00,#02,#40,#10,#02,#40
	db #0d,#04,#04,#40,#10,#04,#40,#00
	db #04,#40,#00,#02,#40,#10,#02,#ff
	db #0d,#06,#3c,#0d,#03,#04,#ff,#fe
	db #40,#ff,#4c,#00,#08,#40,#10,#06
	db #4e,#00,#02,#4c,#00,#08,#40,#10
	db #08,#4c,#00,#08,#40,#10,#06,#4e
	db #00,#02,#4c,#00,#08,#40,#10,#06
	db #4e,#00,#02,#ff,#4c,#00,#06,#40
	db #10,#06,#4e,#00,#02,#4c,#00,#08
	db #40,#10,#08,#4e,#00,#02,#4c,#00
	db #08,#40,#10,#06,#4e,#00,#02,#4c
	db #00,#05,#40,#10,#0b,#ff,#0d,#04
	db #3c,#40,#00,#02,#40,#00,#02,#ff
	db #00,#40,#ff,#57,#26,#24,#0e,#06
	db #20,#02,#06,#23,#0e,#06,#20,#02
	db #06,#22,#0e,#06,#20,#02,#06,#21
	db #0e,#06,#20,#02,#ff,#57,#26,#24
	db #40,#ff,#57,#26,#20,#16,#50,#20
	db #0a,#55,#20,#08,#57,#20,#08,#58
	db #20,#05,#5c,#20,#0b,#ff,#57,#36
	db #24,#02,#5c,#30,#02,#57,#30,#02
	db #5c,#30,#02,#57,#30,#02,#5c,#30
	db #02,#64,#30,#02,#63,#30,#02,#57
	db #30,#02,#5c,#30,#02,#57,#30,#02
	db #5c,#30,#02,#57,#30,#02,#5c,#30
	db #02,#64,#30,#02,#63,#30,#02,#57
	db #30,#02,#5c,#30,#02,#57,#30,#02
	db #5c,#30,#02,#57,#30,#02,#5c,#30
	db #02,#64,#30,#02,#63,#30,#02,#57
	db #3f,#22,#5c,#30,#02,#57,#30,#02
	db #5c,#30,#02,#57,#30,#02,#5c,#30
	db #02,#64,#30,#02,#63,#30,#02,#ff
	db #57,#26,#24,#08,#06,#24,#08,#06
	db #25,#08,#06,#25,#08,#06,#26,#08
	db #06,#26,#08,#06,#27,#08,#06,#27
	db #08,#ff,#04,#47,#30,#04,#47,#20
...
;
.music_info
	db "Acid Music Box 3 Megas (1995)(Acid)(Eliot)",0
	db "ST-128 Module",0
