; Music of Acid Music Box 3 Boom Shak (1995)(Acid)(Greg)(ST-128 Module)
...
.l4640 equ $ + 6
.l463a
	db #20,#4a,#71,#4a,#c2,#4a,#e0,#46
	db #20,#47,#40,#47,#00,#00,#60,#47
	db #a0,#47,#c0,#47,#00,#00,#d2,#ff
	db #d2,#48,#12,#49,#40,#48,#e0,#47
	db #20,#48,#40,#48,#09,#00,#e0,#47
	db #60,#48,#80,#48,#00,#00,#a4,#ff
	db #76,#ff,#76,#ff,#a4,#ff,#a4,#ff
	db #76,#ff,#76,#ff,#a4,#ff,#e0,#47
	db #a0,#48,#40,#47,#18,#07,#c0,#48
	db #00,#49,#40,#47,#18,#07,#20,#49
	db #60,#49,#80,#49,#00,#00,#a0,#49
	db #e0,#49,#00,#4a,#00,#00,#a4,#ff
...
.l46c0 equ $ + 6
	...
	db #05,#08,#0c,#10,#15,#19,#1f,#1a
	db #17,#12,#0f,#0b,#09,#07,#05,#03
	db #02,#00,#00,#00,#00,#00,#00,#00
	db #00,#00,#00,#00,#00,#00,#00,#13
	db #4b,#00,#13,#4b,#00,#74,#4b,#00
	db #15,#4c,#00,#76,#4c,#00,#d7,#4c
	db #00,#d7,#4c,#00,#d7,#4c,#00,#d7
	db #4c,#00,#d7,#4c,#00,#d7,#4c,#00
	db #d7,#4c,#00,#d7,#4c,#00,#d7,#4c
	db #00,#d7,#4c,#00,#d7,#4c,#00,#d7
	db #4c,#00,#d7,#4c,#00,#d7,#4c,#00
	db #d7,#4c,#00,#d7,#4c,#00,#d7,#4c
	db #00,#d7,#4c,#00,#d7,#4c,#00,#d7
	db #4c,#00,#78,#4d,#80,#20,#4a,#00
	db #d9,#4d,#00,#d9,#4d,#00,#d9,#4d
	db #00,#e6,#4d,#00,#f3,#4d,#00,#38
	db #4e,#00,#38,#4e,#00,#38,#4e,#00
	db #38,#4e,#00,#1b,#4f,#00,#1b,#4f
	db #00,#4d,#4f,#00,#4d,#4f,#00,#1b
	db #4f,#00,#1b,#4f,#00,#b9,#4e,#00
	db #b9,#4e,#00,#94,#4f,#00,#94,#4f
	db #00,#f8,#4f,#00,#f8,#4f,#00,#1b
	db #4f,#00,#1b,#4f,#00,#74,#50,#00
	db #74,#50,#00,#d9,#4d,#80,#71,#4a
	db #00,#8d,#50,#00,#ee,#50,#00,#07
	db #51,#00,#20,#51,#00,#3a,#51,#00
	db #8d,#51,#00,#8d,#51,#00,#8d,#51
	db #00,#8d,#51,#00,#d1,#52,#00,#d1
	db #52,#00,#30,#52,#00,#30,#52,#00
	db #d1,#52,#00,#d1,#52,#00,#30,#52
	db #00,#30,#52,#00,#72,#53,#00,#72
	db #53,#00,#72,#53,#00,#72,#53,#00
	db #d1,#52,#00,#d1,#52,#00,#72,#53
	db #00,#72,#53,#00,#33,#54,#80,#c2
	db #4a,#38,#01,#21,#35,#01,#21,#38
	db #01,#21,#35,#01,#21,#38,#01,#21
	db #35,#01,#21,#38,#01,#21,#35,#01
	db #21,#31,#01,#21,#2e,#01,#21,#31
	db #01,#21,#2e,#01,#21,#31,#01,#21
	db #2e,#01,#21,#31,#01,#21,#2e,#01
	db #21,#38,#01,#21,#35,#01,#21,#38
	db #01,#21,#35,#01,#21,#38,#01,#21
	db #35,#01,#21,#38,#01,#21,#35,#01
	db #21,#38,#01,#20,#35,#01,#20,#38
	db #01,#20,#35,#01,#20,#38,#01,#20
	db #35,#01,#20,#38,#01,#20,#35,#01
	db #20,#ff,#35,#01,#11,#01,#11,#35
...
;
.music_info
	db "Acid Music Box 3 Boom Shak (1995)(Acid)(Greg)",0
	db "ST-128 Module",0
