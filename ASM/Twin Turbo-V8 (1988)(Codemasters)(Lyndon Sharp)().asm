; Music of Twin Turbo-V8 (1988)(Codemasters)(Lyndon Sharp)()
...
.lb46b equ $ + 4
	db #00,#00,#00,#00,#1e,#09,#b0,#06
	db #19,#f6,#28,#00,#ff,#63,#01,#00
.lb477
	db #1e,#05,#c0,#04,#14,#f6,#20,#00
.lb483 equ $ + 4
	db #01,#0f,#01,#00,#05,#04,#00,#00
	db #01,#f7,#00,#00,#ff,#05,#01,#00
.lb48f
	db #05,#04,#01,#00,#01,#f7,#00,#00
.lb49b equ $ + 4
	db #ff,#05,#01,#00,#19,#63,#80,#03
	db #0f,#fe,#01,#00,#ff,#06,#00,#00
.lb4a7
	db #19,#63,#80,#02,#0f,#fe,#02,#00
.lb4b3 equ $ + 4
	db #ff,#06,#00,#00,#14,#04,#d0,#00
	db #0f,#fe,#09,#00,#01,#ff,#00,#00
.lb4bf
	db #0a,#14,#80,#01,#1e,#fe,#48,#00
.lb4cb equ $ + 4
	db #ff,#ff,#00,#00,#28,#ff,#20,#00
	db #0f,#fe,#00,#00,#00,#01,#00,#00
.lb4dd equ $ + 6
.lb4dc equ $ + 5
.lb4db equ $ + 4
.lb4da equ $ + 3
...
.lb52e
	...
	dw lb584,lb59c,lb584,lb5ad
.lb560 equ $ + 2
	dw #0000,lb6f9,lb5be,lb5d6
	dw lb5be,lb5e7,lb5be,lb5d6
	dw lb5be,lb5e7,lb5f8,lb60f
	dw lb6fc,lb5f8,lb60f,lb6f9
.lb580 equ $ + 2
	dw #0000,lb625,#0000
.lb584
...
.lb5ad equ $ + 1
	db #87,#e3,#0c,#18,#e1,#0c,#0c,#18
	db #e5,#0c,#e3,#18,#e1,#0c,#18,#0c
.lb5be equ $ + 2
	db #18,#87,#8a,#88,#01,#01,#82,#d3
	db #c0,#e3,#23,#23,#e1,#20,#20,#23
	db #e5,#23,#e3,#23,#e1,#20,#20,#23
.lb5d6 equ $ + 2
	db #23,#87,#e3,#20,#20,#e1,#1c,#1c
	db #20,#e5,#20,#e3,#20,#e1,#1c,#1c
.lb5e7 equ $ + 3
	db #20,#20,#87,#1f,#1f,#1f,#1f,#1c
	db #1c,#1f,#1f,#1f,#1f,#1f,#1f,#1c
.lb5f8 equ $ + 4
	db #1c,#1f,#1f,#87,#8a,#88,#02,#02
	db #d5,#c0,#fb,#28,#e1,#23,#ff,#25
	db #e1,#8f,#fb,#28,#e1,#23,#ff,#24
.lb60f equ $ + 3
	db #e1,#8f,#87,#8a,#c9,#88,#01,#01
	db #fb,#34,#e1,#2f,#ff,#31,#e1,#8f
	db #fb,#34,#e1,#2f,#ff,#30,#e1,#8f
.lb625 equ $ + 1
	db #87,#8b,#d8,#e3,#27,#e1,#27,#27
	db #d9,#e3,#8c,#46,#d8,#8b,#e1,#27
	db #8c,#e5,#27,#e1,#27,#27,#d9,#e3
	db #8c,#46,#52,#87
.lb644 equ $ + 4
.lb640
	dw lb64e,#0000,lb674,#0000
.lb648
	dw lb625,lb69a,#0000
.lb64e
...
.lb674 equ $ + 6
	db #14,#15,#16,#e7,#1a,#8e,#8a,#d1
	db #e1,#c0,#88,#01,#01,#82,#21,#21
	db #21,#21,#1e,#1e,#21,#21,#21,#21
	db #21,#21,#1e,#1e,#21,#21,#e7,#15
	db #e0,#16,#17,#18,#19,#1a,#1b,#1c
.lb69a equ $ + 4
	db #1d,#e7,#21,#8e,#ff,#80,#87
.lb6a1 equ $ + 4
.lb69d
	dw lb6a9,#0000,lb6bc,#0000
.lb6a5
	dw lb6cf,#0000
.lb6a9
...
.lb6bc equ $ + 3
	db #e4,#18,#8e,#8a,#88,#01,#01,#82
	db #c0,#d2,#e1,#24,#24,#27,#27,#e0
.lb6cf equ $ + 6
	db #29,#e1,#2a,#e4,#2b,#8e,#8a,#88
	db #01,#01,#82,#c9,#d2,#e1,#30,#30
	db #33,#33,#e0,#35,#e1,#36,#e4,#37
	db #8e
.lb6e2
	dw lb584,lb59c,lb584,lb5ad
.lb6ec equ $ + 2
	dw #0000,lb5be,lb5d6,lb5be
	dw lb5e7,#0000
.lb6fc equ $ + 6
.lb6f9 equ $ + 3
	db #89,#00,#87,#89,#03,#87,#89,#05
	db #87
;
.music_info
	db "Twin Turbo-V8 (1988)(Codemasters)(Lyndon Sharp)",0
	db "",0
